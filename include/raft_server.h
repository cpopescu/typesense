...
class TimedSnapshotClosure : public braft::Closure {
 ...
 public:
  TimedSnapshotClosure(ReplicationState* replication_state)
...
class ReplicationState : public braft::StateMachine {
 ...
 public:
  ...
  ReplicationState(HttpServer* server, BatchedIndexer* batched_indexer,
  ...
  bool is_read_caught_up() const { return read_caught_up; }

  bool is_write_caught_up() const { return write_caught_up; }
 ...
 private:
  ...
  std::string get_node_url_path(const std::string& node_addr,
