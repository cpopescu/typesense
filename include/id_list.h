...
class id_list_t {
 public:
  ...
  struct result_iter_state_t {
    ...
    result_iter_state_t(uint32_t* excluded_result_ids,
 ...
 public:
  ...
  static void merge(const std::vector<id_list_t*>& id_lists,
                    std::vector<uint32_t>& result_ids);

  static void intersect(const std::vector<id_list_t*>& id_lists,
                        std::vector<uint32_t>& result_ids);

  static bool take_id(result_iter_state_t& istate, uint32_t id);

  template <class T>
  static bool block_intersect(std::vector<id_list_t::iterator_t>& its,
...
template <class T>
bool id_list_t::block_intersect(std::vector<id_list_t::iterator_t>& its,
                                result_iter_state_t& istate, T func) {
  switch (its.size()) {
    case 0:
      break;
