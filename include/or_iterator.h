...
/*
 *  Takes a list of posting list iterators and returns an unique OR sequence of
 * elements lazily
 */
class or_iterator_t {
 private:
 ...
 public:
  ...
  template <class T>
  static bool intersect(std::vector<or_iterator_t>& its,
                        result_iter_state_t& istate, T func);
};

template <class T>
bool or_iterator_t::intersect(std::vector<or_iterator_t>& its,
                              result_iter_state_t& istate, T func) {
