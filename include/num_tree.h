...
class num_tree_t {
 private:
  ...
  [[nodiscard]] bool range_inclusive_contains(const int64_t& start,
                                              const int64_t& end,
 ...
 public:
  ...
  void range_inclusive_search(int64_t start, int64_t end, uint32_t** ids,
                              size_t& ids_len);

  void approx_range_inclusive_search_count(int64_t start, int64_t end,
                                           uint32_t& ids_len);
  ...
  void search(NUM_COMPARATOR comparator, int64_t value, uint32_t** ids,
              size_t& ids_len);

  void approx_search_count(NUM_COMPARATOR comparator, int64_t value,
                           uint32_t& ids_len);
