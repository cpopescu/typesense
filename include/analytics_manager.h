...
class AnalyticsManager {
 private:
  ...
  Option<bool> create_popular_queries_index(nlohmann::json& payload,
                                            bool upsert, bool write_to_disk);
 ...
 public:
  ...
  void persist_suggestions(ReplicationState* raft_server,
