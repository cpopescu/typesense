...
class SynonymIndex {
 private:
  ...
  void synonym_reduction_internal(
 ...
 public:
  ...
  static std::string get_synonym_key(const std::string& collection_name,
  ...
  Option<bool> add_synonym(const std::string& collection_name,
                           const synonym_t& synonym,
                           bool write_to_store = true);

  Option<bool> remove_synonym(const std::string& collection_name,
                              const std::string& id);
};