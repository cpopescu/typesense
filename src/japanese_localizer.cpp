...
void JapaneseLocalizer::write_data_file(const std::string& base64_data,
...
bool JapaneseLocalizer::init() {
  ...
  std::vector<std::string> arguments = {"./kakasi", "-JH",    "-KH",
                                        "-s",       "-iutf8", "-outf8"};
...
JapaneseLocalizer::JapaneseLocalizer() { init(); }
