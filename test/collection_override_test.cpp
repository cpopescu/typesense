...
TEST_F(CollectionOverrideTest, ExcludeIncludeExactQueryMatch) {
  ...
  Option<nlohmann::json> res_op =
      coll_mul_fields->search("of", {"title"}, "", facets, {}, {0}, 10);
  ...
  nlohmann::json override_json_include = {
      {"id", "include-rule"},
      {"rule", {{"query", "in"}, {"match", override_t::MATCH_EXACT}}}};
  ...
  nlohmann::json override_contains_inc = {
      {"id", "include-rule"},
      {"rule", {{"query", "will"}, {"match", override_t::MATCH_CONTAINS}}}};
  ...
  override_contains_inc["includes"][1]["position"] =
      7;  // purposely setting it way out
  ...
  res_op =
      coll_mul_fields->search("will smith", {"title"}, "", {}, {}, {0}, 10);
  ASSERT_TRUE(res_op.ok());
  results = res_op.get();
  ...
  res_op = coll_mul_fields->search(
      "will", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false}, 0,
      spp::sparse_hash_set<std::string>(), spp::sparse_hash_set<std::string>(),
      10, "", 30, 4, "", 0, {}, {}, {}, 0, "<mark>", "</mark>", {1}, 10000,
      true, false, enable_overrides);
  ASSERT_TRUE(res_op.ok());
  results = res_op.get();
...
TEST_F(CollectionOverrideTest, OverrideJSONValidation) {
  ...
  parse_op = override_t::parse(include_json, "", override2);
  ASSERT_FALSE(parse_op.ok());
  ASSERT_STREQ("Inclusion `position` must be an integer.",
               parse_op.error().c_str());
  ...
  ASSERT_FALSE(parse_op.ok());
  ASSERT_STREQ(
      "Must contain one of: `includes`, `excludes`, `filter_by`, `sort_by`, "
      "`remove_matched_tokens`, `replace_query`.",
      parse_op.error().c_str());
  ...
  parse_op = override_t::parse(include_json2, "", override2);
  ASSERT_FALSE(parse_op.ok());
  ASSERT_STREQ("The `includes` value must be an array of objects.",
               parse_op.error().c_str());
  ...
  ASSERT_FALSE(parse_op.ok());
  ASSERT_STREQ("The `excludes` value must be an array of objects.",
               parse_op.error().c_str());
}
...
TEST_F(CollectionOverrideTest, IncludeHitsFilterOverrides) {
  ...
  nlohmann::json override_json_include = {
      {"id", "include-rule"},
      {"rule", {{"query", "not-found"}, {"match", override_t::MATCH_EXACT}}}};
  ...
  auto results =
      coll_mul_fields
          ->search("not-found", {"title"}, "points:>70", {"starring"}, {}, {0},
                   10, 1, FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will")
          .get();
  ...
  results =
      coll_mul_fields
          ->search("not-found", {"title"}, "points:>70", {"starring"}, {}, {0},
                   ...
                   true, "", false, 6000 * 1000, 4, 7, fallback, 4, {off},
                   32767, 32767, 2, 1)
          .get();
...
TEST_F(CollectionOverrideTest, ExcludeIncludeFacetFilterQuery) {
  ...
  auto results =
      coll_mul_fields
          ->search("not-found", {"title"}, "", {"starring"}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will")
          .get();

  ASSERT_EQ("<mark>Will</mark> Ferrell",
  ...
  nlohmann::json override_json_exclude = {
      {"id", "exclude-rule"},
      {"rule", {{"query", "the"}, {"match", override_t::MATCH_EXACT}}}};
  ...
  results =
      coll_mul_fields
          ->search("the", {"title"}, "", {"starring"}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: scott")
          .get();

  ASSERT_EQ(9, results["found"].get<size_t>());

  // "count" would be `2` without exclusion
  ASSERT_EQ("<mark>Scott</mark> Glenn",
            results["facet_counts"][0]["counts"][0]["highlighted"]
                .get<std::string>());
  ASSERT_EQ(1, results["facet_counts"][0]["counts"][0]["count"].get<size_t>());

  ASSERT_EQ("Kristin <mark>Scott</mark> Thomas",
  ...
  results =
      coll_mul_fields
          ->search("the", {"title"}, "", {"starring"}, {}, {0}, 0, 1, FREQUENCY,
  ...
  results = coll_mul_fields
                ->search("not-found", {"title"}, "", {"starring"}, {}, {0}, 1,
  ...
  ASSERT_STREQ(
      "found",
      coll_mul_fields->get_overrides()["include-rule"].rule.query.c_str());

  coll_mul_fields->remove_override("include-rule");
}

TEST_F(CollectionOverrideTest, FilterCuratedHitsSlideToCoverMissingSlots) {
  // when some of the curated hits are filtered away, lower ranked hits must be
  // pulled up
  nlohmann::json override_json_include = {
      {"id", "include-rule"},
      {"rule", {{"query", "scott"}, {"match", override_t::MATCH_EXACT}}}};

  // first 2 hits won't match the filter, 3rd position should float up to
  // position 1
  override_json_include["includes"] = nlohmann::json::array();
  override_json_include["includes"][0] = nlohmann::json::object();
  ...
  auto results =
      coll_mul_fields
          ->search("scott", {"starring"}, "points:>55", {}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "")
          .get();
  ...
  override_json_include = {
      {"id", "include-rule"},
      {"rule", {{"query", "glenn"}, {"match", override_t::MATCH_EXACT}}}};
  ...
  results =
      coll_mul_fields
          ->search("glenn", {"starring"}, "points:[43,86]", {}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "")
          .get();
...
TEST_F(CollectionOverrideTest, SimpleOverrideStopProcessing) {
  ...
  nlohmann::json override_json_include = {
      {"id", "include-rule-1"},
      {"rule", {{"query", "shoes"}, {"match", override_t::MATCH_EXACT}}},
  ...
  auto op = override_t::parse(override_json_include, "include-rule-1",
                              override_include1);
  ASSERT_TRUE(op.ok());
  ...
  override_t override_include2;
  op = override_t::parse(override_json_include, "include-rule-2",
                         override_include2);
  ASSERT_TRUE(op.ok());
  coll1->add_override(override_include2);

  auto results = coll1
                     ->search("shoes", {"name"}, "", {}, sort_fields, {2}, 10,
                              1, FREQUENCY, {true}, 0)
                     .get();
  ...
  results = coll1
                ->search("shoes", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
  ...
  nlohmann::json override_json_test = {
      ...
      {"rule", {{"query", "fast"}, {"match", override_t::MATCH_CONTAINS}}},
  };
  ...
  op = override_t::parse(override_json_test, "include-rule-test",
                         override_include_test);
  ASSERT_TRUE(op.ok());
...
TEST_F(CollectionOverrideTest, IncludeOverrideWithFilterBy) {
  ...
  override_json_include = {
      {"id", "include-rule-2"},
      {"rule", {{"query", "test"}, {"match", override_t::MATCH_EXACT}}},
      {"filter_curated_hits", false},
      {"stop_processing", false},
      {"remove_matched_tokens", false},
      {"filter_by", "price >55"}};
  ...
  results = coll1
                ->search("random-name", {"name"}, "", {}, sort_fields, {2}, 10,
                         1, FREQUENCY, {true}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());
}
...
TEST_F(CollectionOverrideTest, ReplaceQuery) {
  ...
  auto results = coll1
                     ->search("boots", {"name"}, "", {}, sort_fields, {2}, 10,
                              1, FREQUENCY, {true}, 0)
                     .get();
  ...
  ASSERT_FALSE(op.ok());
  ASSERT_EQ(
      "Only one of `replace_query` or `remove_matched_tokens` can be "
      "specified.",
      op.error());
...
TEST_F(CollectionOverrideTest, RuleQueryMustBeCaseInsensitive) {
  ...
  auto results = coll1
                     ->search("great shoes", {"name"}, "", {}, sort_fields, {2},
                              10, 1, FREQUENCY, {true}, 0)
                     .get();
  ...
  results = coll1
                ->search("ball", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest, RuleQueryWithAccentedChars) {
  ...
  auto results = coll1
                     ->search("grün", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                              FREQUENCY, {true}, 0)
                     .get();
...
TEST_F(CollectionOverrideTest, WindowForRule) {
  ...
  override_json["effective_from_ts"] =
      35677971263;  // year 3100, here we come! ;)
  op = override_t::parse(override_json, "rule-1", override_rule);
  ASSERT_TRUE(op.ok());
  coll1->add_override(override_rule);

  results = coll1
                ->search("boots", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());
...
TEST_F(CollectionOverrideTest, FilterRule) {
  ...
  auto results = coll1
                     ->search("*", {}, "points: 50", {}, sort_fields, {2}, 10,
                              1, FREQUENCY, {true}, 0)
                     .get();
  ...
  // empty query should not trigger override even though it will be deemed as
  // wildcard search
  results = coll1
                ->search("", {"name"}, "points: 50", {}, sort_fields, {2}, 10,
                         1, FREQUENCY, {true}, 0)
                .get();
  ...
  results = coll1
                ->search("socks", {"name"}, "points: 1", {}, sort_fields, {2},
                         10, 1, FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest,
       CurationGroupingNonCuratedHitsShouldNotAppearOutside) {
  Collection *coll1;
  ...
  // when only one of the 2 records belonging to a record is used for curation,
  // the other record should not appear back
  ...
  ASSERT_EQ("2", results["grouped_hits"][0]["hits"][0]["document"]["id"]
                     .get<std::string>());
  ASSERT_EQ("3", results["grouped_hits"][1]["hits"][0]["document"]["id"]
                     .get<std::string>());

  // same for keyword search
  results = coll1
                ->search("the", {"title"}, "", {}, {}, {0}, 50, 1, FREQUENCY,
                         {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
...
TEST_F(CollectionOverrideTest, PinnedAndHiddenHits) {
  ...
  auto results =
      coll_mul_fields
          ->search("the", {"title"}, "", {"starring"}, {}, {0}, 50, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will",
                   30, 5, "", 10, pinned_hits, {})
  ...
  ASSERT_STREQ("16",
               results["hits"][3]["document"]["id"].get<std::string>().c_str());
  ASSERT_STREQ("6",
               results["hits"][4]["document"]["id"].get<std::string>().c_str());

  // pinning + filtering
  results = coll_mul_fields
                ->search("of", {"title"}, "points:>58", {}, {}, {0}, 50, 1,
                         FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "",
                         10, pinned_hits, {})
  ...
  results = coll_mul_fields
                ->search("of", {"title"}, "points:>58", {}, {}, {0}, 50, 1,
                         ...
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "",
                         10, pinned_hits, {}, {}, 0, "<mark>", "</mark>", {},
                         1000, true, false, true, "", false, 6000 * 1000, 4, 7,
                         fallback, 4, {off}, 32767, 32767, 2, 1)
                .get();
  ...
  ASSERT_EQ("The Silence <mark>of</mark> the Lambs",
            results["hits"][1]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ("Confessions <mark>of</mark> a Shopaholic",
            results["hits"][2]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ("Percy Jackson: Sea <mark>of</mark> Monsters",
            results["hits"][3]["highlights"][0]["snippet"].get<std::string>());
  ...
  results =
      coll_mul_fields
          ->search("the", {"title"}, "", {"starring"}, {}, {0}, 50, 1,
                   ...
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will",
                   30, 5, "", 10, pinned_hits, hidden_hits)
          .get();
  ...
  results =
      coll_mul_fields
          ->search("the", {"title"}, "", {"starring"}, {}, {0}, 2, 2, FREQUENCY,
                   {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will",
                   30, 5, "", 10, pinned_hits, hidden_hits)
  ...
  // trying to include an ID that is also being hidden via `hidden_hits` query
  // param will not work as pinned and hidden hits will take precedence over
  // override rules
  override_json_include["includes"] = nlohmann::json::array();
  override_json_include["includes"][0] = nlohmann::json::object();
  ...
  results = coll_mul_fields
                ->search("the", {"title"}, "", {"starring"}, {}, {0}, 50, 1,
                         ...
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10,
                         "starring: will", 30, 5, "", 10, {}, {hidden_hits})
                .get();
...
TEST_F(CollectionOverrideTest, PinnedHitsSmallerThanPageSize) {
  ...
  auto results = coll_mul_fields
                     ->search("the", {"title"}, "", {"starring"}, {}, {0}, 8, 1,
                              FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10,
                              "starring: will", 30, 5, "", 10, pinned_hits, {})
                     .get();
  ...
  results = coll_mul_fields
                ->search("the", {"title"}, "", {"starring"}, {}, {0}, 8, 2,
                         FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10,
                         "starring: will", 30, 5, "", 10, pinned_hits, {})
...
TEST_F(CollectionOverrideTest, PinnedHitsLargerThanPageSize) {
  ...
  auto results = coll_mul_fields
                     ->search("the", {"title"}, "", {"starring"}, {}, {0}, 2, 1,
                              FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10,
                              "starring: will", 30, 5, "", 10, pinned_hits, {})
  ...
  results = coll_mul_fields
                ->search("the", {"title"}, "", {"starring"}, {}, {0}, 2, 2,
                         FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10,
                         "starring: will", 30, 5, "", 10, pinned_hits, {})
  ...
  results = coll_mul_fields
                ->search("the", {"title"}, "", {"starring"}, {}, {0}, 2, 3,
                         FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10,
                         "starring: will", 30, 5, "", 10, pinned_hits, {})
...
TEST_F(CollectionOverrideTest, PinnedHitsWhenThereAreNotEnoughResults) {
  ...
  auto results =
      coll_mul_fields
          ->search("not-foundquery", {"title"}, "", {"starring"}, {}, {0}, 10,
                   1, FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "starring: will",
                   30, 5, "", 10, pinned_hits, {})
  ...
  results = coll_mul_fields
                ->search("burgundy", {"title"}, "", {"starring"}, {}, {0}, 10,
                         1, FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10,
                         "starring: will", 30, 5, "", 10, pinned_hits, {})
...
TEST_F(CollectionOverrideTest, HiddenHitsHidingSingleResult) {
  ...
  std::vector<std::vector<std::string>> records = {{"Down There by the Train"}};
  ...
  results = coll1
                ->search("the train", {"title"}, "points:0", {}, {}, {0}, 50, 1,
                         FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "",
                         10, "", hidden_hits)
...
TEST_F(CollectionOverrideTest, PinnedHitsGrouping) {
  ...
  // without any grouping parameter, only the first ID in a position should be
  // picked and other IDs should appear in their original positions
  ...
  ASSERT_STREQ(
      "Chris Evans",
      results["grouped_hits"][0]["group_key"][0][0].get<std::string>().c_str());
  ASSERT_STREQ(
      "Scarlett Johansson",
      results["grouped_hits"][0]["group_key"][0][1].get<std::string>().c_str());

  ASSERT_STREQ("6", results["grouped_hits"][0]["hits"][0]["document"]["id"]
                        .get<std::string>()
                        .c_str());
  ASSERT_STREQ("8", results["grouped_hits"][0]["hits"][1]["document"]["id"]
                        .get<std::string>()
                        .c_str());

  ASSERT_STREQ("1", results["grouped_hits"][1]["hits"][0]["document"]["id"]
                        .get<std::string>()
                        .c_str());

  ASSERT_STREQ("13", results["grouped_hits"][2]["hits"][0]["document"]["id"]
                         .get<std::string>()
                         .c_str());
  ASSERT_STREQ("4", results["grouped_hits"][2]["hits"][1]["document"]["id"]
                        .get<std::string>()
                        .c_str());

  ASSERT_STREQ("11", results["grouped_hits"][3]["hits"][0]["document"]["id"]
                         .get<std::string>()
                         .c_str());
  ASSERT_STREQ("16", results["grouped_hits"][4]["hits"][0]["document"]["id"]
                         .get<std::string>()
                         .c_str());
}

TEST_F(CollectionOverrideTest,
       PinnedHitsGroupingNonPinnedHitsShouldNotAppearOutside) {
  Collection *coll1;
...
TEST_F(CollectionOverrideTest, PinnedHitsWithWildCardQuery) {
  ...
  if (coll1 == nullptr) {
    coll1 =
        collectionManager.create_collection("coll1", 3, fields, "points").get();
  }
  ...
  std::vector<size_t> expected_ids = {
      12, 11, 10, 9, 8, 6, 5, 3, 2, 1, 0};  // 4 and 7 should be missing
...
TEST_F(CollectionOverrideTest, PinnedHitsIdsHavingColon) {
  ...
  std::string pinned_hits_str =
      "https://example.com/1:1, https://example.com/3:2";  // can have space

  auto res_op = coll1->search("*", {"url"}, "", {}, {}, {0}, 25, 1, FREQUENCY,
                              {false}, Index::DROP_TOKENS_THRESHOLD,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10, "", 30,
                              5, "", 10, pinned_hits_str, {});
  ...
  ASSERT_STREQ("https://example.com/1",
               res["hits"][0]["document"]["id"].get<std::string>().c_str());
  ASSERT_STREQ("https://example.com/3",
               res["hits"][1]["document"]["id"].get<std::string>().c_str());
  ASSERT_STREQ("https://example.com/10",
               res["hits"][2]["document"]["id"].get<std::string>().c_str());
  ASSERT_STREQ("https://example.com/9",
               res["hits"][3]["document"]["id"].get<std::string>().c_str());
  ASSERT_STREQ("https://example.com/2",
               res["hits"][9]["document"]["id"].get<std::string>().c_str());
...
TEST_F(CollectionOverrideTest, DynamicFilteringExactMatchBasics) {
  ...
  auto results = coll1
                     ->search("shoes", {"name", "category", "brand"}, "", {},
                              sort_fields, {2, 2, 2}, 10)
                     .get();
  ...
  nlohmann::json override_json = {
      ...
      {"rule", {{"query", "{category}"}, {"match", override_t::MATCH_EXACT}}},
  ...
  override_json = {
      ...
      {"rule",
       {{"query", "{brand} {category}"}, {"match", override_t::MATCH_EXACT}}},
      {"remove_matched_tokens", true},
  ...
  override_json = {
      ...
      {"rule", {{"query", "{brand}"}, {"match", override_t::MATCH_EXACT}}},
      {"remove_matched_tokens", true},
  ...
  results = coll1
                ->search("running shoes", {"name", "category", "brand"}, "", {},
                         sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
                .get();

  ASSERT_EQ(3, results["hits"].size());

  results = coll1
                ->search("adidas shoes", {"name", "category", "brand"}, "", {},
                         sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
                .get();
  ...
  results = coll1
                ->search("adidas", {"name", "category", "brand"}, "", {},
                         sort_fields, {2, 2, 2}, 10)
                .get();
  ...
  op = override_t::parse(override_json_bad1, "dynamic-filters-bad1",
                         override_bad1);
  ASSERT_FALSE(op.ok());
  ...
  op = override_t::parse(override_json_bad2, "dynamic-filters-bad2",
                         override_bad2);
  ASSERT_FALSE(op.ok());
...
TEST_F(CollectionOverrideTest, DynamicFilteringMultiplePlaceholders) {
  ...
  // not an exact match of rule (because of "light") so all results will be
  // fetched, not just Air Jordan brand
  auto results =
      coll1
          ->search("Nike Air Jordan light yellow shoes",
                   {"name", "category", "brand"}, "", {}, sort_fields,
                   {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
          .get();
  ...
  results = coll1
                ->search("New Nike Air Jordan yellow shoes",
                         {"name", "category", "brand"}, "", {}, sort_fields,
                         {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
                .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringTokensBetweenPlaceholders) {
  ...
  auto results = coll1
                     ->search("Nike Air Jordan shoes yellow",
                              {"name", "category", "brand"}, "", {},
                              sort_fields, {2, 2, 2}, 10)
                     .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringWithNumericalFilter) {
  ...
  auto results =
      coll1
          ->search("popular nike shoes", {"name", "category", "brand"}, "", {},
                   sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
          .get();
  ASSERT_EQ(4, results["hits"].size());
  ...
  results = coll1
                ->search("popular nike shoes", {"name", "category", "brand"},
                         "", {}, sort_fields, {2, 2, 2}, 10, 1, FREQUENCY,
                         {false, false, false}, 10,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         1, {}, {}, {}, 0, "<mark>", "</mark>", {1, 1, 1},
                         10000, true, false, enable_overrides)
                .get();
  ASSERT_EQ(4, results["hits"].size());
  ...
  results =
      coll1
          ->search("running adidas shoes", {"name", "category", "brand"}, "",
                   {}, sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {false}, 10)
          .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringExactMatch) {
  ...
  auto results =
      coll1
          ->search("really popular nike shoes", {"name", "category", "brand"},
                   "", {}, sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {true}, 10)
          .get();
  ...
  results =
      coll1
          ->search("popular nike running shoes", {"name", "category", "brand"},
                   "", {}, sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {true}, 10)
          .get();
  ...
  results =
      coll1
          ->search("popular nike shoes running", {"name", "category", "brand"},
                   "", {}, sort_fields, {2, 2, 2}, 10, 1, FREQUENCY, {true}, 10)
          .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringWithSynonyms) {
  ...
  coll1->add_synonym(
      R"({"id": "sneakers-shoes", "root": "sneakers", "synonyms": ["shoes"]})"_json);
  coll1->add_synonym(
      R"({"id": "boots-shoes", "root": "boots", "synonyms": ["shoes"]})"_json);
  coll1->add_synonym(
      R"({"id": "exciting-amazing", "root": "exciting", "synonyms": ["amazing"]})"_json);
  ...
  ASSERT_EQ("category: {category}",
            override_json["filter_by"].get<std::string>());
  ASSERT_EQ(true, override_json["remove_matched_tokens"]
                      .get<bool>());  // must be true by default

  nlohmann::json override_json2 = {
      {"id", "static-filters"},
      {"rule", {{"query", "exciting"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
  ...
  auto results = coll1
                     ->search("sneakers", {"name", "category", "brand"}, "", {},
                              sort_fields, {2, 2, 2}, 10)
                     .get();
  ...
  results = coll1
                ->search("boots", {"name", "category", "brand"}, "", {},
                         sort_fields, {2, 2, 2}, 10)
                .get();
  ...
  results = coll1
                ->search("exciting", {"name", "category", "brand"}, "", {},
                         sort_fields, {2, 2, 2}, 10)
                .get();
...
TEST_F(CollectionOverrideTest, StaticFiltering) {
  ...
  nlohmann::json override_json_contains = {
      {"id", "static-filters"},
      {"rule", {{"query", "expensive"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"filter_by", "price:> 100"}};

  override_t override_contains;
  auto op = override_t::parse(override_json_contains, "static-filters",
                              override_contains);
  ASSERT_TRUE(op.ok());
  ...
  nlohmann::json override_json_exact = {
      ...
      {"rule", {{"query", "cheap"}, {"match", override_t::MATCH_EXACT}}},
      {"remove_matched_tokens", true},
      {"filter_by", "price:< 100"}};

  override_t override_exact;
  op = override_t::parse(override_json_exact, "static-exact-filters",
                         override_exact);
  ASSERT_TRUE(op.ok());
  ...
  auto results = coll1
                     ->search("expensive shoes", {"name"}, "", {}, sort_fields,
                              {2}, 10, 1, FREQUENCY, {true}, 0)
                     .get();
  ...
  results = coll1
                ->search("expensive", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
  ...
  // partial word should not match
  results = coll1
                ->search("inexpensive shoes", {"name"}, "", {}, sort_fields,
  ...
  results =
      coll1->search("cheap", {"name"}, "", {}, sort_fields, {2}, 10).get();
  ...
  results = coll1->search("cheap boots", {"name"}, "", {}, sort_fields, {2}, 10)
                .get();

  ASSERT_EQ(0, results["hits"].size());

  // with synonym for expensive: should NOT match as synonyms are resolved after
  // override substitution
  coll1->add_synonym(
      R"({"id": "costly-expensive", "root": "costly", "synonyms": ["expensive"]})"_json);

  results = coll1
                ->search("costly", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest, StaticFilteringMultipleRuleMatch) {
  ...
  nlohmann::json override_filter1_json = {
      {"id", "static-filter-1"},
      {"rule", {{"query", "twitter"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"stop_processing", false},
      {"filter_by", "tags: twitter"}};

  override_t override_filter1;
  auto op = override_t::parse(override_filter1_json, "static-filter-1",
                              override_filter1);
  ASSERT_TRUE(op.ok());
  ...
  nlohmann::json override_filter2_json = {
      {"id", "static-filter-2"},
      {"rule", {{"query", "starred"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"stop_processing", false},
      {"filter_by", "tags: starred"}};

  override_t override_filter2;
  op = override_t::parse(override_filter2_json, "static-filter-2",
                         override_filter2);
  ASSERT_TRUE(op.ok());
  ...
  auto results = coll1
                     ->search("starred twitter", {"name"}, "", {}, sort_fields,
                              {2}, 10, 1, FREQUENCY, {true}, 0)
                     .get();
  ...
  op = override_t::parse(override_filter1_json, "static-filter-1",
                         override_filter1_reset);
  ASSERT_TRUE(op.ok());
  override_t override_filter2_reset;
  op = override_t::parse(override_filter2_json, "static-filter-2",
                         override_filter2_reset);
  ASSERT_TRUE(op.ok());
  ...
  results = coll1
                ->search("starred twitter", {"name"}, "", {}, sort_fields, {2},
                         10, 1, FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringMultipleRuleMatch) {
  ...
  nlohmann::json override_filter1_json = {
      {"id", "dynamic-filter-1"},
      {"rule", {{"query", "{brand}"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"stop_processing", false},
      {"filter_by", "tags: twitter"}};

  override_t override_filter1;
  auto op = override_t::parse(override_filter1_json, "dynamic-filter-1",
                              override_filter1);
  ASSERT_TRUE(op.ok());
  ...
  nlohmann::json override_filter2_json = {
      {"id", "dynamic-filter-2"},
      {"rule", {{"query", "{tags}"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"stop_processing", false},
      {"filter_by", "tags: starred"}};

  override_t override_filter2;
  op = override_t::parse(override_filter2_json, "dynamic-filter-2",
                         override_filter2);
  ASSERT_TRUE(op.ok());
  ...
  auto results = coll1
                     ->search("starred nike", {"name"}, "", {}, sort_fields,
                              {2}, 10, 1, FREQUENCY, {true}, 0)
                     .get();
  ...
  override_t override_filter1_reset;
  op = override_t::parse(override_filter1_json, "dynamic-filter-1",
                         override_filter1_reset);
  ASSERT_TRUE(op.ok());
  override_t override_filter2_reset;
  op = override_t::parse(override_filter2_json, "dynamic-filter-2",
  ...
  results = coll1
                ->search("starred nike", {"name"}, "", {}, sort_fields, {2}, 10,
                         1, FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest, SynonymsAppliedToOverridenQuery) {
  ...
  coll1->add_synonym(
      R"({"id": "", "root": "shoes", "synonyms": ["sneakers"]})"_json);
...
TEST_F(CollectionOverrideTest, StaticFilterWithAndWithoutQueryStringMutation) {
  ...
  nlohmann::json override_json_contains = {
      {"id", "static-filters"},
      {"rule", {{"query", "apple"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", false},
      {"filter_by", "price:> 200"}};
  ...
  auto results = coll1
                     ->search("apple", {"name"}, "", {}, sort_fields, {2}, 10,
                              1, FREQUENCY, {true}, 0)
                     .get();
  ...
  op = override_t::parse(override_json_contains, "static-filters",
                         override_contains);
  ASSERT_TRUE(op.ok());
  coll1->add_override(override_contains);

  results = coll1
                ->search("apple", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                         FREQUENCY, {true}, 0)
                .get();
...
TEST_F(CollectionOverrideTest, DynamicFilteringWithJustRemoveTokens) {
  ...
  auto results = coll1
                     ->search("all", {"name", "category", "brand"}, "", {},
                              sort_fields, {0, 0, 0}, 10)
                     .get();
  ...
  nlohmann::json override_json = {
      {"id", "match-all"},
      {"rule", {{"query", "all"}, {"match", override_t::MATCH_EXACT}}},
      {"remove_matched_tokens", true}};
  ...
  results = coll1
                ->search("really amazing shoes", {"name", "category", "brand"},
                         "", {}, sort_fields, {0, 0, 0}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  override_json = {
      ...
      {"rule", {{"query", "really"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true}};
...
TEST_F(CollectionOverrideTest, StaticSorting) {
  ...
  nlohmann::json override_json_contains = {
      {"id", "static-sort"},
      {"rule", {{"query", "shoes"}, {"match", override_t::MATCH_CONTAINS}}},
      {"remove_matched_tokens", true},
      {"sort_by", "price:desc"}};

  override_t override_contains;
  auto op = override_t::parse(override_json_contains, "static-sort",
                              override_contains);
  ASSERT_TRUE(op.ok());
...
TEST_F(CollectionOverrideTest, DynamicFilteringWithPartialTokenMatch) {
  // when query tokens do not match placeholder field value exactly, don't do
  // filtering
  Collection *coll1;
  ...
  auto results =
      coll1->search("shoes", {"name"}, "", {}, sort_fields, {0}, 10).get();
  ...
  results = coll1->search("shox", {"name"}, "", {}, sort_fields, {0}, 10).get();
...
TEST_F(CollectionOverrideTest, OverrideWithSymbolsToIndex) {
  ...
  coll1 = collectionManager.get_collection("coll1").get();
  if (coll1 == nullptr) {
    coll1 = collectionManager
                .create_collection("coll1", 1, fields, "",
  ...
  auto results =
      coll1
          ->search("non-stick", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 10)
          .get();
  ...
  nlohmann::json override_json = {
      {"id", "ov-1"},
      {"rule", {{"query", "non-stick"}, {"match", override_t::MATCH_EXACT}}},
  ...
  results =
      coll1
          ->search("nonstick", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                   FREQUENCY, {false}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 10)
          .get();
