...
TEST_F(CollectionInfixSearchTest, InfixBasics) {
  ...
  auto results =
      coll1
          ->search("100037", {"title"}, "", {}, {}, {0}, 3, 1, FREQUENCY,
  ...
  ASSERT_EQ("<mark>GH100037IN8900X</mark>",
  ...
  // always behavior: both prefix and infix matches are returned but ranked
  // below prefix match
...
TEST_F(CollectionInfixSearchTest, InfixOnArray) {
  std::vector<field> fields = {
      field("model_numbers", field_types::STRING_ARRAY, false, false, true, "",
            -1, 1),
      field("points", field_types::INT32, false),
  };
  ...
  nlohmann::json doc;
  doc["id"] = "0";
  doc["model_numbers"] = {"GH100037IN8900X", "GH100047IN8900X",
                          "GH100057IN8900X"};
  doc["points"] = 100;
  ASSERT_TRUE(coll1->add(doc.dump()).ok());
  ...
  auto results =
      coll1
          ->search("47in", {"model_numbers"}, "", {}, {}, {0}, 3, 1, FREQUENCY,
                   {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                   "model_numbers", 20, {}, {}, {}, 0, "<mark>", "</mark>", {},
                   1000, true, false, true, "", false, 6000 * 1000, 4, 7,
                   fallback, 4, {always})
          .get();
  ...
  ASSERT_EQ(1, results["hits"][0]["highlights"].size());
  ASSERT_EQ("model_numbers",
            results["hits"][0]["highlights"][0]["field"].get<std::string>());
  ASSERT_EQ(
      "<mark>GH100047IN8900X</mark>",
      results["hits"][0]["highlights"][0]["snippets"][0].get<std::string>());
  ASSERT_EQ(
      "<mark>GH100047IN8900X</mark>",
      results["hits"][0]["highlights"][0]["values"][0].get<std::string>());
...
TEST_F(CollectionInfixSearchTest, InfixWithFiltering) {
  ...
  auto results =
      coll1
          ->search("37in8", {"title"}, "points: 200", {}, {}, {0}, 3, 1,
...
TEST_F(CollectionInfixSearchTest, RespectPrefixAndSuffixLimits) {
  ...
  results = coll1
                ->search("8900", {"title"}, "", {}, {}, {0}, 3, 1, FREQUENCY,
                         {true}, 5, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                         "title", 20, {}, {}, {}, 0, "<mark>", "</mark>", {},
                         1000, true, false, true, "", false, 6000 * 1000, 4, 7,
                         fallback, 4, {always}, INT16_MAX, 2)
                .get();
...
TEST_F(CollectionInfixSearchTest, InfixSpecificField) {
  ...
  auto results =
      coll1
          ->search("100037", {"title", "description"}, "", {}, {}, {0}, 3, 1,
                   FREQUENCY, {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, fallback, 4,
  ...
  results =
      coll1
          ->search("16736", {"title", "description"}, "", {}, {}, {0}, 3, 1,
                   FREQUENCY, {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, fallback, 4,
  ...
  ASSERT_EQ("description",
            results["hits"][0]["highlights"][0]["field"].get<std::string>());
  ASSERT_EQ("<mark>HYU16736GY6372</mark>",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
...
TEST_F(CollectionInfixSearchTest, InfixDeleteAndUpdate) {
  ...
  for (size_t i = 0;
       i < coll1->_get_index()->_get_infix_index().at("title").size(); i++) {
    ASSERT_EQ(
        0, coll1->_get_index()->_get_infix_index().at("title").at(i)->size());
  }
  ...
  results = coll1
                ->search("342D78", {"title"}, "", {}, {}, {0}, 3, 1, FREQUENCY,
                         {true}, 5, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                         "title", 20, {}, {}, {}, 0, "<mark>", "</mark>", {},
                         1000, true, false, true, "", false, 6000 * 1000, 4, 7,
...
TEST_F(CollectionInfixSearchTest, MultiFielInfixSearch) {
  ...
  auto results =
      coll1
          ->search("100037", {"title", "mpn"}, "", {}, {}, {0}, 3, 1, FREQUENCY,
                   {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, fallback, 4,
