...
#define token_offsets_file_path                                  \
  (std::string(ROOT_DIR) +                                       \
   std::string("external/token_offsets/file/token_offsets.txt")) \
      .c_str()
...
TEST(MatchTest, MatchScoreV2) {
  ...
  token_offsets.clear();
  token_offsets.push_back(
      token_positions_t{false, {38, 50, 170, 187, 195, 222}});
