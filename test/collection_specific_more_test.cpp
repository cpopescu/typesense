...
TEST_F(CollectionSpecificMoreTest, PrefixExpansionWhenExactMatchExists) {
  ...
  auto results =
      coll1
          ->search("little prince antoine saint", {"title", "author"}, "", {},
                   {}, {2}, 10, 1, FREQUENCY, {true}, 1,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   5, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificMoreTest, PrefixExpansionOnSingleField) {
  ...
  std::vector<std::string> tokens = {
      "Mark Jack",    "John Jack",   "John James",    "John Joseph",
      "John Jim",     "John Jordan", "Mark Nicholas", "Mark Abbey",
      "Mark Boucher", "Mark Bicks",  "Mark Potter"};
...
TEST_F(CollectionSpecificMoreTest, TypoCorrectionShouldUseMaxCandidates) {
  ...
  auto results =
      coll1
          ->search("independent", {"title"}, "", {}, {}, {2}, 30, 1, FREQUENCY,
...
TEST_F(CollectionSpecificMoreTest, PrefixExpansionOnMultiField) {
  ...
  std::vector<std::string> names = {
      "John Stewart", "John Smith",  "John Scott", "John Stone",
      "John Romero",  "John Oliver", "John Adams"};

  std::vector<std::string> locations = {"Switzerland", "Seoul",     "Sydney",
                                        "Surat",       "Stockholm", "Salem",
                                        "Sevilla"};
  ...
  auto results =
      coll1
          ->search("john s", {"location", "name"}, "", {}, {}, {0}, 100, 1,
                   MAX_SCORE, {true}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, off, 4)
          .get();

  // tokens are ordered by max_score and prefix continuation on the same field
  // is prioritized
  ...
  // when more than 4 candidates are requested, "s" matches with other fields
  // are returned
  results =
      coll1
          ->search("john s", {"location", "name"}, "", {}, {}, {0}, 100, 1,
                   ...
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, off, 10)
          .get();
...
TEST_F(CollectionSpecificMoreTest,
       ArrayElementMatchShouldBeMoreImportantThanTotalMatch) {
  std::vector<field> fields = {
      field("title", field_types::STRING, false),
      field("author", field_types::STRING, false),
  ...
  doc2["author"] = "Rowling";
  doc2["tags"] = {"harry",  "potter", "prisoner", "azkaban",
                  "beasts", "guide",  "rowling"};

  nlohmann::json doc3;
  doc3["id"] = "2";
  doc3["title"] = "Fantastic beasts and where to find them";
  doc3["author"] = "Rowling";
  doc3["tags"] = {"harry potter", "prisoner azkaban", "beasts", "guide",
                  "rowling"};
  ...
  auto results =
      coll1
          ->search("harry potter rowling prisoner azkaban",
                   {"title", "author", "tags"}, "", {}, {}, {2}, 10, 1,
...
TEST_F(CollectionSpecificMoreTest, ArrayMatchAcrossElementsMustNotMatter) {
  ...
  doc1["tags"] = {"por do sol", "immateur", "gemsor", "praia",
                  "sol",        "vermelho", "suyay"};
  ...
  auto results =
      coll1
          ->search("praia por sol vermelho", {"title", "author", "tags"}, "",
                   {}, {}, {2}, 10, 1, FREQUENCY, {true}, 1,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   5, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
...
TEST_F(CollectionSpecificMoreTest,
       MatchedSegmentMoreImportantThanTotalMatches) {
  std::vector<field> fields = {field("title", field_types::STRING, false),
                               field("author", field_types::STRING, false)};
  ...
  doc2["id"] = "1";
  doc2["title"] =
      "One Four Five Six Seven Eight Nine Ten Eleven Twelve Thirteen Fourteen "
      "Three Rowling";
  doc2["author"] = "Two";
  ...
  auto results =
      coll1
          ->search("one two three rowling", {"title", "author"}, "", {}, {},
                   {2}, 10, 1, FREQUENCY, {true}, 1,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   5, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
...
TEST_F(CollectionSpecificMoreTest, VerbatimMatchNotOnPartialTokenMatch) {
  ...
  doc2["tags"] = {"foo", "bar", "Hundred",
                  "One Eleven Thirteen Fourteen Three"};
  ...
  auto results =
      coll1
          ->search("hundred thirteen fourteen", {"tags"}, "", {}, {}, {2}, 10,
...
TEST_F(CollectionSpecificMoreTest, SortByStringEmptyValuesConfigFirstField) {
  ...
  auto results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
  ASSERT_EQ(4, results["hits"].size());
  ...
  // ascending
  sort_fields = {
      sort_by("points(missing_values: first)", "ASC"),
  };
  results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
  ...
  sort_fields = {
      sort_by("points(missing_values: last)", "ASC"),
  };
  results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
  ...
  // descending
  sort_fields = {
      sort_by("points(missing_values: first)", "DESC"),
  };
  results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
  ...
  sort_fields = {
      sort_by("points(missing_values: last)", "DESC"),
  };
  results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
  ...
  // bad syntax
  sort_fields = {
      sort_by("points(foo: bar)", "desc"),
  };
  auto res_op = coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1,
                              MAX_SCORE, {true});
  ASSERT_FALSE(res_op.ok());
  ASSERT_EQ("Bad syntax for sorting field `points`", res_op.error());

  sort_fields = {
      sort_by("points(missing_values: bar)", "desc"),
  };
  res_op = coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE,
                         {true});
  ASSERT_FALSE(res_op.ok());
  ASSERT_EQ("Bad syntax for sorting field `points`", res_op.error());
}
...
TEST_F(CollectionSpecificMoreTest, SortByStringEmptyValuesConfigThirdField) {
  ...
  // without any order config: missing integers always end up last
  sort_fields = {sort_by("points2", "asc"), sort_by("points3", "asc"),
                 sort_by("points", "asc")};
  auto results =
      coll1->search("*", {}, "", {}, sort_fields, {0}, 10, 1, MAX_SCORE, {true})
          .get();
...
TEST_F(CollectionSpecificMoreTest, WrongTypoCorrection) {
  ...
  auto results =
      coll1
          ->search("earrings", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
...
TEST_F(CollectionSpecificMoreTest, PositionalTokenRanking) {
  ...
  std::vector<std::string> tokens = {"Alpha Beta Gamma", "Omega Alpha Theta",
                                     "Omega Theta Alpha",
                                     "Indigo Omega Theta Alpha"};
  ...
  auto results =
      coll1
          ->search("alpha", {"title"}, "", {}, {}, {0}, 100, 1, MAX_SCORE,
  ...
  results = coll1
                ->search("theta alpha", {"title"}, "", {}, {}, {0}, 100, 1,
                         MAX_SCORE, {true}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                         false, true, "", false, 6000 * 1000, 4, 7, fallback, 4,
...
TEST_F(CollectionSpecificMoreTest, PositionalTokenRankingWithArray) {
  ...
  auto results =
      coll1
          ->search("alpha", {"tags"}, "", {}, {}, {0}, 100, 1, MAX_SCORE,
                   {true}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false, 6000 * 1000, 4, 7, fallback, 4, {off},
                   32767, 32767, 2, false, false)
          .get();
...
TEST_F(CollectionSpecificMoreTest, ExactFilteringOnArray) {
  ...
  nlohmann::json doc1;
  doc1["tags"] = {"§ 23", "§ 34d EStG", "§ 23 Satz EStG"};
  doc1["points"] = 100;
  ...
  auto results =
      coll1
          ->search("*", {"tags"}, "tags:=§ 23 EStG", {}, {}, {0}, 100, 1,
                   MAX_SCORE, {true}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
  ...
  results = coll1
                ->search("*", {"tags"}, "tags:=§ 23 Satz", {}, {}, {0}, 100, 1,
                         MAX_SCORE, {true}, Index::DROP_TOKENS_THRESHOLD,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
...
TEST_F(CollectionSpecificMoreTest, ExactFilteringOnArray2) {
  ...
  auto results =
      coll1
          ->search("*", {}, "capability:=Encoding capabilities", {}, {}, {0},
                   100, 1, MAX_SCORE, {true}, Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false, 6000 * 1000, 4, 7, fallback, 4, {off},
...
TEST_F(CollectionSpecificMoreTest, SplitTokensCrossFieldMatching) {
  ...
  auto results = coll1
                     ->search("paulaschoice c1", {"name", "brand"}, "", {}, {},
...
TEST_F(CollectionSpecificMoreTest, PrefixSearchOnSpecificFields) {
  ...
  std::vector<std::string> names = {"Jungle Girl", "Jungle Girlz", "Jam Foo1",
                                    "Jam Foo2",    "Jam Foo3",     "Jam Foo4",
                                    "Jam Foo"};

  std::vector<std::string> brands = {"Foobar", "Foobar2", "Girlx", "Girly",
                                     "Girlz",  "Girlz",   "Girlzz"};
  ...
  auto results = coll1
                     ->search("jungle girl", {"name", "brand"}, "", {}, {}, {0},
                              10, 1, FREQUENCY, {false, true}, 0)
                     .get();

  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("jam foo", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {true}, 0)
                .get();
...
TEST_F(CollectionSpecificMoreTest, OrderWithThreeSortFields) {
  ...
  sort_fields = {sort_by("type", "desc"), sort_by("valid_from", "desc"),
                 sort_by("created_at", "desc")};

  auto results = coll1
                     ->search("s", {"name"}, "", {}, sort_fields, {2}, 10, 1,
                              FREQUENCY, {true}, 0)
                     .get();
...
TEST_F(CollectionSpecificMoreTest, LongString) {
  ...
  auto results = coll1
                     ->search(name, {"name"}, "", {}, sort_fields, {2}, 10, 1,
                              FREQUENCY, {true}, 0)
                     .get();
...
TEST_F(CollectionSpecificMoreTest, RelevanceConsiderAllFields) {
  std::vector<field> fields = {
      field("f1", field_types::STRING, false),
  ...
  auto results =
      coll1
          ->search("alpha", {"f1", "f2", "f3"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {true}, 0, spp::sparse_hash_set<std::string>(),
  ...
  ASSERT_EQ("578730123365711899",
            results["hits"][0]["text_match_info"]["score"].get<std::string>());
  ASSERT_EQ(
      3, results["hits"][0]["text_match_info"]["fields_matched"].get<size_t>());
  ASSERT_EQ(
      2, results["hits"][1]["text_match_info"]["fields_matched"].get<size_t>());
  ASSERT_EQ(
      1, results["hits"][2]["text_match_info"]["fields_matched"].get<size_t>());

  ASSERT_EQ(
      1, results["hits"][0]["text_match_info"]["tokens_matched"].get<size_t>());
  ASSERT_EQ(
      1, results["hits"][1]["text_match_info"]["tokens_matched"].get<size_t>());
  ASSERT_EQ(
      1, results["hits"][2]["text_match_info"]["tokens_matched"].get<size_t>());

  ASSERT_EQ("1108091339008",
            results["hits"][0]["text_match_info"]["best_field_score"]
                .get<std::string>());
  ASSERT_EQ("1108091339008",
            results["hits"][1]["text_match_info"]["best_field_score"]
                .get<std::string>());
  ASSERT_EQ("1108091339008",
            results["hits"][2]["text_match_info"]["best_field_score"]
                .get<std::string>());

  ASSERT_EQ(
      3,
      results["hits"][0]["text_match_info"]["best_field_weight"].get<size_t>());
  ASSERT_EQ(
      3,
      results["hits"][1]["text_match_info"]["best_field_weight"].get<size_t>());
  ASSERT_EQ(
      3,
      results["hits"][2]["text_match_info"]["best_field_weight"].get<size_t>());
...
TEST_F(CollectionSpecificMoreTest, CrossFieldWeightIsNotAugmentated) {
  ...
  auto results =
      coll1
          ->search("nike shoe", {"type", "title"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {true}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 40,
                   {}, {}, {}, 0, "<mark>", "</mark>", {5, 1})
          .get();
...
TEST_F(CollectionSpecificMoreTest, HighlightWithAccentedChars) {
  ...
  auto results = coll1
                     ->search("rap", {"title", "companies"}, "", {}, {}, {2},
                              10, 1, FREQUENCY, {true})
                     .get();

  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("<mark>Rāp</mark>eti Early Learning Centre",
...
TEST_F(CollectionSpecificMoreTest, FieldWeightNormalization) {
  ...
  coll1->process_search_field_weights(raw_search_fields, query_by_weights,
...
TEST_F(CollectionSpecificMoreTest, SearchingForMinusCharacter) {
  // when the minus character is part of symbols_to_index it should not be used
  // as exclusion operator
  std::vector<field> fields = {
      field("name", field_types::STRING, false),
      field("points", field_types::INT32, false),
  };
  ...
  results =
      coll1->search("-", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {true}, 0)
          .get();
...
TEST_F(CollectionSpecificMoreTest, UpsertUpdateEmplaceShouldAllRemoveIndex) {
  ...
  auto results = coll1
                     ->search("foo", {"title1"}, "", {}, {}, {0}, 10, 1,
                              FREQUENCY, {false})
                     .get();
  ASSERT_EQ(0, results["found"].get<size_t>());

  results = coll1
                ->search("bar", {"title2"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false})
                .get();
  ASSERT_EQ(1, results["found"].get<size_t>());
  ASSERT_EQ(3, results["hits"][0]["document"].size());

  // via update, existing index should not be removed because update can send
  // partial doc
  ...
  // via emplace, existing index should not be removed because emplace could
  // send partial doc
  ...
  results = coll1
                ->search("baz", {"title3"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false})
                .get();
  ASSERT_EQ(1, results["found"].get<size_t>());
}
...
TEST_F(CollectionSpecificMoreTest, UpdateWithEmptyArray) {
  ...
  results =
      coll1->search("one", {"tags"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false})
          .get();
  ASSERT_EQ(0, results["found"].get<size_t>());
}
...
TEST_F(CollectionSpecificMoreTest, UpdateArrayWithNullValue) {
  ...
  results = coll1
                ->search("alpha", {"tags"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false})
                .get();
  ASSERT_EQ(0, results["found"].get<size_t>());
...
TEST_F(CollectionSpecificMoreTest, ReplaceArrayElement) {
  ...
  auto results =
      coll1
          ->search("beta", {"tags"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false})
          .get();
  ASSERT_EQ(0, results["found"].get<size_t>());
  ...
  results =
      coll1->search("two", {"tags"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false})
          .get();
  ASSERT_EQ(0, results["found"].get<size_t>());
}
...
TEST_F(CollectionSpecificMoreTest, UnorderedWeightingOfFields) {
  ...
  auto res_op = coll1->search(
      "rg0761", {"title", "brand", "sku"}, "", {}, {}, {2, 2, 0}, 10, 1,
      FREQUENCY, {true}, 0, spp::sparse_hash_set<std::string>(),
  ...
  // with prefix
  res_op = coll1->search("rgx", {"title", "brand", "sku"}, "", {}, {},
                         {2, 2, 0}, 10, 1, FREQUENCY, {true, true, false}, 0,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         40, {}, {}, {}, 0, "<mark>", "</mark>", {10, 7, 10});
...
TEST_F(CollectionSpecificMoreTest, IncludeFieldsOnlyId) {
  ...
  auto res_op = coll1->search("*", {}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                              {true}, 0, {"id"});
...
TEST_F(CollectionSpecificMoreTest, QueryWithOnlySpecialChars) {
  ...
  auto res_op =
      coll1->search("--", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true});
...
TEST_F(CollectionSpecificMoreTest, CopyDocHelper) {
  ...
  // when both nested & flattened forms are present, copy only flat form for
  // collection without nesting enabled
  src = R"({
        "baz": {"name": "John"},
        "baz.name": "John"
    })"_json;
...
TEST_F(CollectionSpecificMoreTest, HighlightFieldWithBothFlatAndNestedForm) {
  ...
  auto res =
      coll1
          ->search("john", {"name.first"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
  ...
  ASSERT_EQ(
      "<mark>John</mark>",
      res["hits"][0]["highlight"]["name.first"]["snippet"].get<std::string>());
}
...
TEST_F(CollectionSpecificMoreTest, HighlightWordWithSymbols) {
  ...
  auto res =
      coll1
          ->search("favicon", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                   "locations.address", 20, {}, {}, {}, 0, "<mark>", "</mark>",
                   {}, 1000, true, false, true, "title")
          .get();
...
TEST_F(CollectionSpecificMoreTest,
       HighlightObjectShouldBeEmptyWhenNoHighlightFieldFound) {
  nlohmann::json schema = R"({
        "name": "coll1",
        "fields": [
            {"name": "title", "type": "string"},
  ...
  auto res_op = coll1->search(
      "brand", {"title", "brand", "sku"}, "", {}, {}, {2, 2, 0}, 10, 1,
...
TEST_F(CollectionSpecificMoreTest, WildcardSearchWithNoSortingField) {
  ...
  auto res_op =
      coll1->search("*", {}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true});
  ...
  res_op = coll1->search("*", {}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true});
...
TEST_F(CollectionSpecificMoreTest, AutoSchemaWithObjectValueAsFirstDoc) {
  // when a value is `object` initially and then is integer, updating that
  // object should not cause errors
  nlohmann::json schema = R"({
        "name": "coll1",
        "fields": [
            {"name": ".*", "type": "auto"}
  ...
  auto res =
      coll1->search("*", {}, "num:100", {}, {}, {2}, 10, 1, FREQUENCY, {true})
          .get();
  ASSERT_EQ(1, res["hits"].size());
}
...
TEST_F(CollectionSpecificMoreTest, ValidateQueryById) {
  ...
  auto res_op = coll1->search("doc-1", {"id"}, "", {}, {}, {2}, 10, 1,
                              FREQUENCY, {true}, 0);
  ASSERT_FALSE(res_op.ok());
...
TEST_F(CollectionSpecificMoreTest,
       ConsiderDroppedTokensDuringTextMatchScoring) {
  nlohmann::json schema = R"({
            "name": "coll1",
            "fields": [
  ...
  auto res =
      coll1
          ->search("Neutrogena Ultra Sheer Moisturizing Face Serum",
                   {"brand", "name"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true},
                   5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 20,
                   {}, {}, {}, 0, "<mark>", "</mark>", {3, 2}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, fallback, 4,
                   {off}, 0, 0, 0, 2, false, "", true, 0, max_weight)
          .get();
...
TEST_F(CollectionSpecificMoreTest,
       ConsiderDroppedTokensDuringTextMatchScoring2) {
  nlohmann::json schema = R"({
            "name": "coll1",
            "fields": [
                {"name": "name", "type": "string"}
  ...
  auto res =
      coll1
          ->search("avène eau mineral", {"name"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 20,
                   {}, {}, {}, 0, "<mark>", "</mark>", {3}, 1000, true, false,
                   true, "", false, 6000 * 1000, 4, 7, fallback, 4, {off}, 0, 0,
                   0, 2, false, "", true, 0, max_weight)
          .get();
...
TEST_F(CollectionSpecificMoreTest, NonNestedFieldNameWithDot) {
  ...
  auto res =
      coll1
          ->search("shoes", {"category"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                   "category", 20, {}, {}, {}, 0, "<mark>", "</mark>", {1})
          .get();
  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ("0", res["hits"][0]["document"]["id"].get<std::string>());
}
...
TEST_F(CollectionSpecificMoreTest, IncludeExcludeUnIndexedField) {
  ...
  auto res = coll1
                 ->search("sample", {"title"}, "", {}, {}, {2}, 10, 1,
                          FREQUENCY, {true}, 0, {"src"})
                 .get();
  ...
  spp::sparse_hash_set<std::string> include_fields;
  res = coll1
            ->search("sample", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                     {true}, 0, include_fields, {"src"})
            .get();

  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ(2, res["hits"][0]["document"].size());
  ASSERT_EQ("Sample Title 1",
...
TEST_F(CollectionSpecificMoreTest, WildcardIncludeExclude) {
  ...
  auto result =
      coll->search("user_a", {"username"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {true}, Index::DROP_TOKENS_THRESHOLD, {"user*"})
          .get();
  ...
  result = coll->search("user_a", {"username"}, "", {}, {}, {0}, 10, 1,
  ...
  result =
      coll->search("user_a", {"username"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {true}, Index::DROP_TOKENS_THRESHOLD, {"foo.*"})
          .get();
...
TEST_F(CollectionSpecificMoreTest, PhraseMatchRepeatingTokens) {
  ...
  auto res = coll1
                 ->search(R"("super easy super fast")", {"title"}, "", {}, {},
                          {2}, 10, 1, FREQUENCY, {true}, 0)
                 .get();
  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ("0", res["hits"][0]["document"]["id"].get<std::string>());
  ...
  res = coll1
            ->search(R"("super easy super")", {"title"}, "", {}, {}, {2}, 10, 1,
                     FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ("0", res["hits"][0]["document"]["id"].get<std::string>());
  ...
  res = coll1
            ->search(R"("the really easy really fast product really")",
                     {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ("1", res["hits"][0]["document"]["id"].get<std::string>());
  ...
  res = coll1
            ->search(R"("the easy really really product fast really")",
                     {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(0, res["hits"].size());

  res = coll1
            ->search(R"("really the easy really fast product really")",
                     {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(0, res["hits"].size());

  res = coll1
            ->search(R"("super super easy fast")", {"title"}, "", {}, {}, {2},
                     10, 1, FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(0, res["hits"].size());

  res = coll1
            ->search(R"("super super easy")", {"title"}, "", {}, {}, {2}, 10, 1,
                     FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(0, res["hits"].size());

  res = coll1
            ->search(R"("product fast")", {"title"}, "", {}, {}, {2}, 10, 1,
                     FREQUENCY, {true}, 0)
            .get();
  ASSERT_EQ(0, res["hits"].size());
}
...
TEST_F(CollectionSpecificMoreTest, PhraseMatchMultipleFields) {
  ...
  auto res = coll1
                 ->search(R"("tide pools")", {"title", "author"}, "", {}, {},
                          {2}, 10, 1, FREQUENCY, {true}, 0)
                 .get();
  ASSERT_EQ(2, res["hits"].size());
  ASSERT_EQ("0", res["hits"][0]["document"]["id"].get<std::string>());
...
TEST_F(CollectionSpecificMoreTest, PhraseMatchAcrossArrayElements) {
  ...
  auto res =
      coll1
          ->search(R"("state of the art)", {"texts"}, "", {}, {}, {0}, 10, 1,
                   FREQUENCY, {true}, 10, spp::sparse_hash_set<std::string>())
          .get();
  ASSERT_EQ(0, res["hits"].size());
}
...
TEST_F(CollectionSpecificMoreTest, WeightTakingPrecendeceOverMatch) {
  ...
  auto res =
      coll1
          ->search("light mayo", {"brand", "title"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {true}, 5, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 20,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false, 6000 * 1000, 4, 7, fallback, 4, {off}, 0, 0,
  ...
  ASSERT_EQ(
      "1108091338752",
      res["hits"][0]["text_match_info"]["best_field_score"].get<std::string>());
  ASSERT_EQ(
      15, res["hits"][0]["text_match_info"]["best_field_weight"].get<size_t>());
  ASSERT_EQ(2,
            res["hits"][0]["text_match_info"]["fields_matched"].get<size_t>());
  ASSERT_EQ(2,
            res["hits"][0]["text_match_info"]["tokens_matched"].get<size_t>());

  ASSERT_EQ(
      "2211897868288",
      res["hits"][1]["text_match_info"]["best_field_score"].get<std::string>());
  ASSERT_EQ(
      14, res["hits"][1]["text_match_info"]["best_field_weight"].get<size_t>());
  ASSERT_EQ(1,
            res["hits"][1]["text_match_info"]["fields_matched"].get<size_t>());
  ASSERT_EQ(2,
            res["hits"][1]["text_match_info"]["tokens_matched"].get<size_t>());
}
...
TEST_F(CollectionSpecificMoreTest, IncrementingCount) {
  ...
  auto res = coll1
                 ->search("*", {}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 5,
                          spp::sparse_hash_set<std::string>(),
...
TEST_F(CollectionSpecificMoreTest, HighlightOnFieldNameWithDot) {
  ...
  auto res = coll1
                 ->search("infinity", {"org.title"}, "", {}, {}, {2}, 10, 1,
                          FREQUENCY, {true}, 0)
                 .get();

  ASSERT_EQ(1, res["hits"].size());
  ASSERT_EQ(1, res["hits"][0]["highlights"].size());
  ASSERT_EQ("<mark>Infinity</mark> Inc.",
            res["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  nlohmann::json highlight =
      R"({"org.title":{"matched_tokens":["Infinity"],"snippet":"<mark>Infinity</mark> Inc."}})"_json;
...
TEST_F(CollectionSpecificMoreTest, SearchCutoffTest) {
  ...
  auto coll_op = coll1->search(
      "1 2", {"title"}, "", {}, {}, {0}, 3, 1, FREQUENCY, {false}, 5,
      spp::sparse_hash_set<std::string>(), spp::sparse_hash_set<std::string>(),
      10, "", 30, 4, "title", 20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000,
...
TEST_F(CollectionSpecificMoreTest, ExhaustiveSearchWithoutExplicitDropTokens) {
  ...
  auto res = coll1
                 ->search("alpha beta", {"title"}, "", {}, {}, {0}, 3, 1,
                          FREQUENCY, {false}, drop_tokens_threshold,
                          spp::sparse_hash_set<std::string>(),
                          spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                          "title", 20, {}, {}, {}, 0, "<mark>", "</mark>", {},
                          1000, true, false, true, "", exhaustive_search)
                 .get();
...
TEST_F(CollectionSpecificMoreTest,
       DoNotHighlightFieldsForSpecialCharacterQuery) {
  nlohmann::json schema = R"({
        "name": "coll1",
        "fields": [
            {"name": "title", "type": "string"},
  ...
  auto res =
      coll1
          ->search("'", {"title", "description"}, "", {}, {}, {0}, 3, 1,
...
TEST_F(CollectionSpecificMoreTest, SearchForURL) {
  ...
  nlohmann::json doc;
  doc["url"] =
      "https://www.cpf.gov.sg/member/infohub/cpf-clarifies/policy-faqs/"
  ...
  auto res =
      coll1
          ->search(
              "https://www.cpf.gov.sg/member/infohub/cpf-clarifies/policy-faqs/"
              "why-interest-earned-on-cpf-life-premium-not-paid-to-"
              "beneficiaries",
              {"url"}, "", {}, {}, {2}, 3, 1, FREQUENCY, {true})
          .get();
...
TEST_F(CollectionSpecificMoreTest, CrossFieldTypoAndPrefixWithWeights) {
  ...
  auto res =
      coll1
          ->search("trouzers", {"title", "color"}, "", {}, {}, {2, 0}, 10, 1,
                   FREQUENCY, {true}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 40,
                   {}, {}, {}, 0, "<mark>", "</mark>", {2, 3})
          .get();
  ...
  res = coll1
            ->search("trou", {"title", "color"}, "", {}, {}, {0}, 10, 1,
                     FREQUENCY, {true, false}, 0,
                     spp::sparse_hash_set<std::string>(),
                     spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 40,
                     {}, {}, {}, 0, "<mark>", "</mark>", {2, 3})
            .get();
...
TEST_F(CollectionSpecificMoreTest, RearrangingFilterTree) {
  ...
  const std::string doc_id_prefix = std::to_string(coll->get_collection_id()) +
                                    "_" + Collection::DOC_ID_PREFIX + "_";
...
TEST_F(CollectionSpecificMoreTest, ApproxFilterMatchCount) {
  ...
  Option<bool> filter_op =
      filter::parse_filter_query("name: Jeremy", coll->get_schema(), store,
                                 doc_id_prefix, filter_tree_root);
  ASSERT_TRUE(filter_op.ok());

  uint32_t approx_count = 0;
  coll->_get_index()->_approximate_filter_ids(filter_tree_root->filter_exp,
                                              approx_count);
  ASSERT_EQ(approx_count, 5);

  delete filter_tree_root;
  filter_op = filter::parse_filter_query(
      "location:(48.8662, 2.3255, 48.8581, 2.3209, 48.8561, 2.3448, 48.8641, "
      "2.3469)",
      coll->get_schema(), store, doc_id_prefix, filter_tree_root);
  ASSERT_TRUE(filter_op.ok());
...
TEST_F(CollectionSpecificMoreTest, HybridSearchTextMatchInfo) {
  ...
  auto results = coll1
                     ->search("natural products", {"product_name", "embedding"},
                              "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 0,
                              spp::sparse_hash_set<std::string>())
                     .get();
  ...
  ASSERT_EQ("0",
            results["hits"][0]["text_match_info"]["score"].get<std::string>());
  ASSERT_EQ("0",
            results["hits"][1]["text_match_info"]["score"].get<std::string>());

  ASSERT_EQ(
      0, results["hits"][0]["text_match_info"]["fields_matched"].get<size_t>());
  ASSERT_EQ(
      0, results["hits"][1]["text_match_info"]["fields_matched"].get<size_t>());

  ASSERT_EQ(
      0, results["hits"][0]["text_match_info"]["tokens_matched"].get<size_t>());
  ASSERT_EQ(
      0, results["hits"][1]["text_match_info"]["tokens_matched"].get<size_t>());
}
