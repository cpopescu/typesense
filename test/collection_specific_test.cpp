...
TEST_F(CollectionSpecificTest, SearchTextWithHyphen) {
  ...
  auto results =
      coll1
          ->search("open-access-may-become-mandatory-for-nih-funded-research",
...
TEST_F(CollectionSpecificTest, ExplicitHighlightFieldsConfig) {
  ...
  auto results =
      coll1
          ->search("brown fox pernell", {"title"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 1,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1}, 10000, true, false,
  ...
  ASSERT_EQ("A story about a <mark>brown</mark> <mark>fox</mark> who was fast.",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  ASSERT_EQ("author",
            results["hits"][0]["highlights"][1]["field"].get<std::string>());
  ASSERT_EQ("David <mark>Pernell</mark>",
  ...
  results =
      coll1
          ->search("brown fox pernell", {"title"}, "", {}, {}, {2}, 10, 1,
                   ...
                   "<mark>", "</mark>", {1}, 10000, true, false, true,
                   "description,author")
          .get();
  ...
  results =
      coll1
          ->search("fox", {"title", "author"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {false}, 1, spp::sparse_hash_set<std::string>(),
                   {"description"}, 10, "", 30, 4, "", 1, {}, {}, {}, 0,
                   "<mark>", "</mark>", {1, 1}, 10000, true, false, true,
                   "description")
          .get();
  ...
  ASSERT_EQ("description",
            results["hits"][0]["highlights"][0]["field"].get<std::string>());
  ASSERT_EQ("A story about a brown <mark>fox</mark> who was fast.",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ...
  results =
      coll1
          ->search("fox", {"title", "author"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {false}, 1, spp::sparse_hash_set<std::string>(),
                   {"description"}, 10, "", 30, 4, "description", 1, {}, {}, {},
                   0, "<mark>", "</mark>", {1, 1}, 10000, true, false, true,
                   "description")
          .get();
  ...
  results =
      coll1
          ->search("*", {"title", "author"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {false}, 1, spp::sparse_hash_set<std::string>(),
                   {"description"}, 10, "", 30, 4, "", 1, {}, {}, {}, 0,
                   "<mark>", "</mark>", {1, 1}, 10000, true, false, true,
                   "description,author")
          .get();
  ...
  results =
      coll1
          ->search("*", {}, "", {}, {}, {2}, 10, 1, FREQUENCY, {false}, 1,
                   spp::sparse_hash_set<std::string>(), {"description"}, 10, "",
                   30, 4, "", 1, {}, {}, {}, 0, "<mark>", "</mark>", {1, 1},
                   10000, true, false, true, "description,author")
          .get();
...
TEST_F(CollectionSpecificTest, ExactSingleFieldMatch) {
  ...
  auto results = coll1
                     ->search("charger", {"title", "description"}, "", {}, {},
                              {2}, 10, 1, FREQUENCY, {true, true}, 10,
  ...
  results = coll1
                ->search("charger", {"title", "description"}, "", {}, {}, {2},
                         10, 1, FREQUENCY, {true, true}, 10,
                         spp::sparse_hash_set<std::string>(),
...
TEST_F(CollectionSpecificTest, CheckProgressiveTypoSearching) {
  ...
  auto results = coll1
                     ->search("convenient", {"title", "description"}, "", {},
                              {}, {2}, 10, 1, FREQUENCY, {true, true}, 10,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10, "", 30,
                              4, "title", 1)
...
TEST_F(CollectionSpecificTest, OrderMultiFieldFuzzyMatch) {
  ...
  auto results =
      coll1
          ->search("charger", {"title", "description"}, "", {}, {}, {2}, 10, 1,
...
TEST_F(CollectionSpecificTest, TypoBeforeDropTokens) {
  ...
  auto results = coll1
                     ->search("Josh Lixson", {"title"}, "", {}, {}, {2}, 10, 1,
                              FREQUENCY, {true})
                     .get();
  ...
  results =
      coll1
          ->search("Josh Lixson", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
...
TEST_F(CollectionSpecificTest, FieldWeighting) {
  ...
  auto results =
      coll1
          ->search("brown fox", {"title", "description"}, "", {}, {}, {2}, 10,
...
TEST_F(CollectionSpecificTest, MultiFieldArrayRepeatingTokens) {
  ...
  doc1["description"] =
      "Nexsan Technologies 18 SAN Array - 18 x HDD Supported - 18 x HDD "
      "Installed";
  doc1["attrs"] = {"Hard Drives Supported > 18", "Hard Drives Installed > 18",
                   "SSD Supported > 18"};
  doc1["points"] = 100;
  ...
  auto results =
      coll1
          ->search("rv345 cisco 18", {"title", "description", "attrs"}, "", {},
                   {}, {1}, 10, 1, FREQUENCY, {true, true, true})
          .get();
...
TEST_F(CollectionSpecificTest, ExactMatchOnPrefix) {
  ...
  auto results =
      coll1
          ->search("ged", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true},
                   Index::DROP_TOKENS_THRESHOLD,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 1)
          .get();
...
TEST_F(CollectionSpecificTest, TypoPrefixSearchWithoutPrefixEnabled) {
  ...
  auto results =
      coll1
          ->search("SG25026H", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {false}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "", 1)
          .get();
...
TEST_F(CollectionSpecificTest, PrefixWithTypos) {
  ...
  results = coll1
                ->search("maria", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {false})
                .get();
...
TEST_F(CollectionSpecificTest, PrefixVsExactMatch) {
  ...
  auto results =
      coll1
          ->search("ration", {"title"}, "", {}, {}, {1}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
  ...
  ASSERT_STREQ("0",
               results["hits"][3]["document"]["id"].get<std::string>().c_str());
...
TEST_F(CollectionSpecificTest, PrefixWithTypos2) {
  ...
  doc1["id"] = "0";
  doc1["title"] =
      "Av. Mal. Humberto Delgado 206, 4760-012 Vila Nova de Famalicão, "
      "Portugal";
  doc1["points"] = 100;
...
TEST_F(CollectionSpecificTest, CreateManyCollectionsAndDeleteOneOfThem) {
  ...
  for (size_t i = 0; i <= 10; i++) {
    ...
    ASSERT_TRUE(
        collectionManager.create_collection(coll_name, 1, fields, "points")
            .ok());
  }
...
TEST_F(CollectionSpecificTest, DeleteOverridesAndSynonymsOnDiskDuringCollDrop) {
  ...
  nlohmann::json override_json = {
      {"id", "exclude-rule"},
      {"rule", {{"query", "of"}, {"match", override_t::MATCH_EXACT}}}};
  ...
  // add synonym
  coll1->add_synonym(
      R"({"id": "ipod-synonyms", "synonyms": ["ipod", "i pod", "pod"]})"_json);

  collectionManager.drop_collection("coll1");

  // overrides should have been deleted from the store
  std::vector<std::string> stored_values;
  store->scan_fill(Collection::COLLECTION_OVERRIDE_PREFIX,
                   std::string(Collection::COLLECTION_OVERRIDE_PREFIX) + "`",
                   stored_values);
  ASSERT_TRUE(stored_values.empty());

  // synonyms should also have been deleted from the store
  store->scan_fill(SynonymIndex::COLLECTION_SYNONYM_PREFIX,
                   std::string(SynonymIndex::COLLECTION_SYNONYM_PREFIX) + "`",
                   stored_values);
  ASSERT_TRUE(stored_values.empty());
}
...
TEST_F(CollectionSpecificTest, SingleCharMatchFullFieldHighlight) {
  ...
  auto results =
      coll1
          ->search("a 3-month", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 5, "title",
                   1)
          .get();
  ...
  ASSERT_EQ(
      "Which of the following is <mark>a</mark> probable sign of infection?",
      results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
...
TEST_F(CollectionSpecificTest, TokensSpreadAcrossFields) {
  ...
  auto results =
      coll1
          ->search("foo bar", {"title", "description"}, "", {}, {}, {0}, 10, 1,
...
TEST_F(CollectionSpecificTest, HighlightSecondaryFieldWithPrefixMatch) {
  ...
  auto results =
      coll1
          ->search("function", {"title", "description"}, "", {}, {}, {0}, 10, 1,
                   FREQUENCY, {true, true}, 10,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 40,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1, 1})
...
TEST_F(CollectionSpecificTest, HighlightWithDropTokens) {
  ...
  doc1["id"] = "0";
  doc1["description"] =
      "HPE Aruba AP-575 802.11ax Wireless Access Point - TAA Compliant - 2.40 "
      "GHz, "
      "5 GHz - MIMO Technology - 1 x Network (RJ-45) - Gigabit Ethernet - "
      "Bluetooth 5";
  doc1["points"] = 100;
  ...
  auto results =
      coll1
          ->search("HPE Aruba AP-575 Technology Gigabit Bluetooth 5",
                   {"description"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {true},
                   10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                   "description", 40, {}, {}, {}, 0, "<mark>", "</mark>")
          .get();
  ...
  ASSERT_EQ(
      "<mark>HPE</mark> <mark>Aruba</mark> <mark>AP-575</mark> 802.11ax "
      "Wireless Access Point - "
      "TAA Compliant - 2.40 GHz, <mark>5</mark> GHz - MIMO "
      "<mark>Technology</mark> - 1 x Network (RJ-45) - "
...
TEST_F(CollectionSpecificTest, HighlightLongFieldWithDropTokens) {
  ...
  doc1["id"] = "0";
  doc1["description"] =
      "Tripp Lite USB C to VGA Multiport Video Adapter Converter w/ USB-A Hub, "
      "USB-C PD Charging "
      "Port & Gigabit Ethernet Port, Thunderbolt 3 Compatible, USB Type C to "
      "VGA, USB-C, USB "
  ...
  auto results =
      coll1
          ->search("wired charging gigabit port", {"description"}, "", {}, {},
                   {0}, 10, 1, FREQUENCY, {true}, 1,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                   "description", 1, {}, {}, {}, 0, "<mark>", "</mark>")
          .get();
  ...
  ASSERT_EQ(
      "Tripp Lite USB C to VGA Multiport Video Adapter Converter w/ USB-A Hub, "
      "USB-C PD <mark>Charging</mark> <mark>Port</mark> & <mark>Gigabit</mark> "
      "Ethernet "
      "<mark>Port</mark>, Thunderbolt 3 Compatible, USB Type C to VGA, USB-C, "
      "USB Type-C - for "
      "Notebook/Tablet PC - 2 x USB <mark>Port</mark>s - 2 x USB 3.0 - Network "
      "(RJ-45) - "
      "VGA - <mark>Wired</mark>",
      results["hits"][0]["highlights"][0]["value"].get<std::string>());
...
TEST_F(CollectionSpecificTest, HighlightWithTypoTokensAndPrefixSearch) {
  std::vector<field> fields = {
      field("username", field_types::STRING, false),
  ...
  auto results = coll1
                     ->search("pandaabear bas", {"username", "name"}, "", {},
                              {}, {2, 2}, 10, 1, FREQUENCY, {true, true}, 1,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10, "", 30,
                              4, "", 1, {}, {}, {}, 0, "<mark>", "</mark>")
                     .get();
  ...
  results = coll1
                ->search("pandaabear bas", {"username", "tags"}, "", {}, {},
                         {2, 2}, 10, 1, FREQUENCY, {true, true}, 1,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         1, {}, {}, {}, 0, "<mark>", "</mark>")
  ...
  ASSERT_EQ(2, results["hits"][0]["highlights"].size());
  ASSERT_EQ(
      "<mark>Pandaabear</mark> <mark>Bas</mark>ic",
...
TEST_F(CollectionSpecificTest, PrefixSearchOnlyOnLastToken) {
  std::vector<field> fields = {
      field("concat", field_types::STRING, false),
      field("points", field_types::INT32, false),
  };
  ...
  doc1["id"] = "0";
  doc1["concat"] =
      "SPZ005 SPACEPOLE Spz005 Space Pole Updated!!! Accessories Stands & "
      "Equipment Cabinets POS "
  ...
  auto results =
      coll1
          ->search("spz space", {"concat"}, "", {}, {}, {1}, 10, 1, FREQUENCY,
                   {true}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "concat",
                   20, {}, {}, {}, 0, "<mark>", "</mark>")
          .get();
...
TEST_F(CollectionSpecificTest, TokenStartingWithSameLetterAsPrevToken) {
  ...
  auto results =
      coll1
          ->search("john j", {"name"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>")
          .get();
...
TEST_F(CollectionSpecificTest, CrossFieldMatchingExactMatchOnSingleField) {
  ...
  auto results =
      coll1
          ->search("john vegetable farmer", {"name", "description"}, "", {}, {},
                   {0, 0}, 10, 1, FREQUENCY, {true, true}, 2,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>")
          .get();
  ...
  results = coll1
                ->search("john vegatable farmer", {"name", "description"}, "",
                         {}, {}, {1, 1}, 10, 1, FREQUENCY, {true, true}, 2,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>")
                .get();
...
TEST_F(CollectionSpecificTest, HighlightEmptyArray) {
  ...
  auto results = coll1
                     ->search("john", {"name", "tags"}, "", {}, {}, {0, 0}, 10,
                              1, FREQUENCY, {true, true}, 2,
                              spp::sparse_hash_set<std::string>(),
                              spp::sparse_hash_set<std::string>(), 10, "", 30,
                              4, "", 10, {}, {}, {}, 0, "<mark>", "</mark>")
                     .get();
...
TEST_F(CollectionSpecificTest, CustomSeparators) {
  ...
  Collection* coll1 =
      collectionManager
          .create_collection("coll1", 1, fields, "points", 0, "", {}, {"-"})
          .get();
  ...
  auto results =
      coll1
          ->search("gamma", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 1,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", true)
          .get();
  ...
  ASSERT_EQ(1, results["hits"][0]["highlights"].size());
  ASSERT_EQ("name", results["hits"][0]["highlights"][0]["field"]);
  ASSERT_EQ("alpha-beta-<mark>gamma</mark>-omega-zeta",
            results["hits"][0]["highlights"][0]["snippet"]);

  results =
      coll1
          ->search("gamma-omega", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 1,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false)
  ...
  ASSERT_EQ(1, results["hits"][0]["highlights"].size());
  ASSERT_EQ("name", results["hits"][0]["highlights"][0]["field"]);
  ASSERT_EQ("alpha-beta-<mark>gamma</mark>-<mark>omega</mark>-zeta",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ...
  ASSERT_EQ("`token_separators` should be an array of character symbols.",
            coll_op.error());
...
TEST_F(CollectionSpecificTest, CustomSymbolsForIndexing) {
  ...
  auto results =
      coll1
          ->search("c++", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false},
  ...
  ASSERT_EQ("name",
            results["hits"][0]["highlights"][0]["field"].get<std::string>());
  ASSERT_EQ("Yes, <mark>C++</mark> is great!",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  // without custom symbols, + should not be indexed, so the "C" record will
  // show up first

  Collection* coll2 =
      collectionManager.create_collection("coll2", 1, fields, "points", 0, "")
          .get();
  ...
  results = coll2
                ->search("c++", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false}, 1, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
  ...
  ASSERT_FALSE(coll_op.ok());
  ASSERT_EQ("`symbols_to_index` should be an array of character symbols.",
            coll_op.error());
...
TEST_F(CollectionSpecificTest, CustomSeparatorsHandleQueryVariations) {
  ...
  Collection* coll1 = collectionManager
                          .create_collection("coll1", 1, fields, "points", 0,
                                             "", {}, {"-", ".", "*", "&", "/"})
                          .get();
  ...
  auto results =
      coll1
          ->search("bofrost*dienstl", {"name"}, "", {}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 1,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false)
  ...
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("<mark>bofrost</mark>*<mark>dienstl</mark>",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ...
  results = coll1
                ->search("1&1", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false}, 1, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         1, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                         false, true, "", false)
  ...
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("0", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("<mark>1</mark>&<mark>1</mark> Internet Limited",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ...
  results =
      coll1
          ->search("just grilled", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 1, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 1,
                   {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true, false,
                   true, "", false)
  ...
  ASSERT_EQ("<mark>just</mark>...<mark>grilled</mark>",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
...
TEST_F(CollectionSpecificTest, TypoCorrectionWithFaceting) {
  ...
  auto results =
      coll1
          ->search("salt", {"name", "brand"}, "", {"brand"}, {}, {2}, 10, 1,
  ...
  results = coll1
                ->search("salt", {"name", "brand"}, "brand: Salpices",
                         {"brand"}, {}, {2}, 10, 1, FREQUENCY, {true}, 1,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         1, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                         false, true, "", true)
...
TEST_F(CollectionSpecificTest, MultiFieldVerbatimMatchesShouldBeWeighted) {
  // 2 exact matches on low weighted fields should not overpower a single exact
  // match on high weighted field
  std::vector<field> fields = {
      field("name", field_types::STRING, false),
  ...
  auto results =
      coll1
          ->search("kids", {"name", "category", "label"}, "", {}, {}, {0, 0, 0},
                   10, 1, FREQUENCY, {false, false, false}, 2,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {6, 1, 1})
          .get();
...
TEST_F(CollectionSpecificTest, ZeroWeightedField) {
  ...
  auto results =
      coll1
          ->search("kids", {"category", "name"}, "", {}, {}, {0, 0}, 10, 1,
                   FREQUENCY, {false, false}, 2,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1, 0})
          .get();
...
TEST_F(CollectionSpecificTest, ImportDocumentWithRepeatingIDInTheSameBatch) {
  ...
  auto results =
      coll1
          ->search("levis", {"name"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 2, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {0}, 1000, true)
          .get();
  ...
  import_records.push_back(doc2.dump());
  import_response =
      coll1->add_many(import_records, document, index_operation_t::UPDATE);
  ...
  import_records.push_back(doc2.dump());
  import_response =
      coll1->add_many(import_records, document, index_operation_t::UPSERT);

  ASSERT_TRUE(import_response["success"].get<bool>());
  ASSERT_EQ(2, import_response["num_imported"].get<int>());

  // repeated ID is NOT rejected if the first ID is not indexed due to some
  // error
  import_records.clear();
  doc1.erase("name");
  doc1["id"] = "100";
...
TEST_F(CollectionSpecificTest, UpdateOfTwoDocsWithSameIdWithinSameBatch) {
  std::vector<field> fields = {
      field("last_chance", field_types::BOOL, false, true),
      field("points", field_types::INT32, false),
  };
  ...
  auto results =
      coll1
          ->search("*", {}, "", {}, {}, {0}, 10, 1, FREQUENCY, {true}, 10,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificTest, UpsertOfTwoDocsWithSameIdWithinSameBatch) {
  ...
  Collection* coll1 =
      collectionManager.create_collection("coll1", 1, fields, "").get();
  ...
  // first upsert removes both fields, so second upsert should only insert
  // "points"
  ...
  ASSERT_EQ(1,
            coll1->_get_index()->_get_numerical_index().at("points")->size());
  ASSERT_EQ(
      0, coll1->_get_index()->_get_numerical_index().at("last_chance")->size());
...
TEST_F(CollectionSpecificTest, UpdateUpsertOfDocWithMissingFields) {
  ...
  std::vector<std::string> upserts = {R"({"id": "0"})"};
  ...
  ASSERT_EQ(1,
            coll1->_get_index()->_get_numerical_index().at("points")->size());
  ASSERT_EQ(
      1, coll1->_get_index()->_get_numerical_index().at("last_chance")->size());
...
TEST_F(CollectionSpecificTest, FacetParallelizationVerification) {
  ...
  auto results =
      coll1
          ->search("levis", {"name"}, "", {"category"}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, 2, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {0}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificTest,
       VerbatimMatchShouldConsiderTokensMatchedAcrossAllFields) {
  ...
  auto results =
      coll1
          ->search("hamburger trader", {"name", "brand"}, "", {}, {}, {0, 0},
                   10, 1, FREQUENCY, {false, false}, 2,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1, 1}, 1000, true)
          .get();
  ...
  results =
      coll1
          ->search("potato wedges kfc", {"name", "brand"}, "", {}, {}, {0, 0},
                   10, 1, FREQUENCY, {false, false}, 2,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1, 1}, 1000, true)
...
TEST_F(CollectionSpecificTest, CustomNumTyposConfiguration) {
  ...
  auto results =
      coll1
          ->search("asd", {"brand"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {false},
                   2, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 10,
                   {}, {}, {}, 0, "<mark>", "</mark>", {1}, 1000, true, false,
                   true, "", false, 60000 * 100)
          .get();

  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search("asd", {"brand"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {false}, 2, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>", {1}, 1000,
                         true, false, true, "", false, 60000 * 100, 3, 7)
                .get();
  ...
  results = coll1
                ->search("bixger", {"brand"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {false}, 2, spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>", {1}, 1000,
                         true, false, true, "", false, 60000 * 100)
                .get();
  ...
  results = coll1
                ->search("bixger", {"brand"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         ...
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "",
                         10, {}, {}, {}, 0, "<mark>", "</mark>", {1}, 1000,
                         true, false, true, "", false, 60000 * 100, 3, 6)
                .get();
...
TEST_F(CollectionSpecificTest, RepeatingStringArrayTokens) {
  ...
  // when the first document containing a token already cannot fit compact
  // posting list
  ...
  results = coll1
                ->search("foobar", {"tags"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {false})
                .get();
  ASSERT_EQ(2, results["hits"].size());
...
TEST_F(CollectionSpecificTest, HighlightOnPrefixRegression) {
  ...
  auto results =
      coll1
          ->search("and", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY, {false})
          .get();
  ASSERT_EQ(1, results["hits"].size());
...
TEST_F(CollectionSpecificTest, DroppedTokensShouldNotBeUsedForPrefixSearch) {
  ...
  auto results =
      coll1
          ->search("shoe cat", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
  ...
  results =
      coll1
          ->search("cat shoe", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificTest, SearchShouldSplitAndJoinTokens) {
  ...
  auto results = coll1
                     ->search("non stick", {"title"}, "", {}, {}, {0}, 10, 1,
                              FREQUENCY, {false}, 0)
                     .get();
  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("pressurecooker", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("nonstick pressurecooker", {"title"}, "", {}, {}, {0},
                         10, 1, FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("the pressurecooker", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("pressurecooker great", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ...
  results = coll1
                ->search("the pressureis", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search("greatcooker", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search("t h e", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                         {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());

  results = coll1
                ->search("c o o k e r", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ...
  results = coll1
                ->search("nonstickpressurecooker", {"title"}, "", {}, {}, {0},
                         10, 1, FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  results =
      coll1
          ->search("nonstick pressure cooker is a greatinvention", {"title"},
                   "", {}, {}, {0}, 10, 1, FREQUENCY, {false}, 0)
          .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search("nonstick pressure cooker is a gr eat", {"title"}, "",
                         {}, {}, {0}, 10, 1, FREQUENCY, {false}, 0)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  results =
      coll1
          ->search("non stick", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, off)
          .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  results =
      coll1
          ->search("pressurecooker", {"title"}, "", {}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, off)
          .get();
  ...
  results =
      coll1
          ->search("pressurecopper", {"title"}, "", {}, {}, {0}, 10, 1,
                   FREQUENCY, {false}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20)
          .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("Pressure Copper vessel",
            results["hits"][0]["document"]["title"].get<std::string>());
...
TEST_F(CollectionSpecificTest, SplitJoinTokenAlways) {
  ...
  results =
      coll1
          ->search("non stick", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   ...
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, always)
          .get();
  ...
  results =
      coll1
          ->search("nonstick", {"title"}, "", {}, {}, {0}, 10, 1, FREQUENCY,
                   {false}, 0, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true,
                   false, true, "", false, 6000 * 1000, 4, 7, always)
...
TEST_F(CollectionSpecificTest, TokenCountOfWordsFarApart) {
  // word proximity is calculated using a moving window of X tokens. If only 1
  // token is present in the best matched window, proximity ends up being
  // perfect. So we've to ensure that scoring uses total tokens found and not
  ...
  std::vector<std::vector<std::string>> records = {
      {"Central Arizona Project. - Hearing, Eighty-eighth Congress, Second "
       "Session, on H.R. 6796, H.R. 6797, "
       "H.R. 6798. November 9, 1964, Phoenix, Ariz",
       "JK"},
      {"Project Phoenix", "JK"},
  };
  ...
  auto results =
      coll1
          ->search("Phoenix project)", {"title", "author"}, "", {}, {}, {2}, 10,
                   1, FREQUENCY, {false}, 1,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   1, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
...
TEST_F(CollectionSpecificTest, SingleFieldTokenCountOfWordsFarApart) {
  ...
  auto results =
      coll1
          ->search("Phoenix project)", {"title"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {false}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   10, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificTest, SingleHyphenInQueryNotToBeTreatedAsExclusion) {
  ...
  doc1["id"] = "0";
  doc1["title"] =
      "Saturday Short - Thrive (with Audio Descriptions + Open Captions)";
  doc1["points"] = 100;
  ...
  auto results =
      coll1
          ->search(
              "Saturday Short - Thrive (with Audio Descriptions + Open "
              "Captions)",
              {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY, {true}, 10,
              spp::sparse_hash_set<std::string>(),
              spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title", 20,
...
TEST_F(CollectionSpecificTest, DuplicateFieldsNotAllowed) {
  ...
  Option<Collection*> create_op =
      collectionManager.create_collection("collection", 1, fields);

  ASSERT_FALSE(create_op.ok());
  ASSERT_EQ(create_op.error(),
            "There are duplicate field names in the schema.");
  ASSERT_EQ(create_op.code(), 400);

  // with dynamic field
  fields = {
      field("title_.*", field_types::STRING, false, true),
...
TEST_F(CollectionSpecificTest, EmptyArrayShouldBeAcceptedAsFirstValue) {
  ...
  std::vector<field> fields = {
      field("tags", field_types::STRING_ARRAY, false, true)};
...
TEST_F(CollectionSpecificTest, SimplePrefixQueryHighlight) {
  ...
  auto results =
      coll1
          ->search("basker", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
  ...
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("The Hound of the <mark>Basker</mark>villes",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ("The Hound of the <mark>Basker</mark>villes",
            results["hits"][0]["highlights"][0]["value"].get<std::string>());
  ...
  results =
      coll1
          ->search("bassker", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                   {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
  ...
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("The Hound of the <mark>Baskerv</mark>illes",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ("The Hound of the <mark>Baskerv</mark>illes",
            results["hits"][0]["highlights"][0]["value"].get<std::string>());
  ...
  results =
      coll1
          ->search("hound of bassker", {"title"}, "", {}, {}, {2}, 10, 1,
                   FREQUENCY, {true}, 10, spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {}, 1000, true)
          .get();
  ...
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ(
      "The <mark>Hound</mark> <mark>of</mark> the <mark>Baskerv</mark>illes",
      results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ(
      "The <mark>Hound</mark> <mark>of</mark> the <mark>Baskerv</mark>illes",
      results["hits"][0]["highlights"][0]["value"].get<std::string>());
...
TEST_F(CollectionSpecificTest, PhraseSearch) {
  Collection* coll1;
  std::vector<field> fields = {
      field("title", field_types::STRING, false, true),
      field("points", field_types::INT32, false, true)};
  coll1 = collectionManager.get_collection("coll1").get();
  if (coll1 == nullptr) {
    auto op = collectionManager.create_collection("coll1", 1, fields, "");
  ...
  auto results = coll1
                     ->search(R"(down there by)", {"title"}, "", {}, {}, {0},
                              10, 1, FREQUENCY, {false}, 0)
                     .get();
  ASSERT_EQ(2, results["hits"].size());
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ...
  results = coll1
                ->search(R"(" down there by ")", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("<mark>Down</mark> <mark>There</mark> <mark>by</mark> the Train",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  // phrase search with exclusion
  results = coll1
                ->search(R"("by the" -train)", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("0", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("Then and there <mark>by</mark> <mark>the</mark> down",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  // exclusion of an entire phrase
  results = coll1
                ->search(R"(-"by the down")", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(2, results["hits"].size());
  ASSERT_EQ("2", results["hits"][0]["document"]["id"].get<std::string>());
  ...
  results = coll1
                ->search(R"("by the dinosaur")", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  results = coll1
                ->search(R"("by the state")", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  results = coll1
                ->search(R"("there by the")", {"title"}, "points:>=1", {}, {},
  ...
  results = coll1
                ->search(R"(-"by the dinosaur")", {"title"}, "", {}, {}, {0},
  ...
  results = coll1
                ->search(R"("by the" and)", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ...
  results = coll1
                ->search(R"("train by the")", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search(R"("train the by")", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search(R"("train the")", {"title"}, "", {}, {}, {0}, 10, 1,
                         FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());

  results = coll1
                ->search(R"("trooper state")", {"title"}, "", {}, {}, {0}, 10,
                         1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(0, results["hits"].size());
  ...
  // two phrases
  results = coll1
                ->search(R"("by the" "then and")", {"title"}, "", {}, {}, {0},
                         10, 1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("0", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ(
      "<mark>Then</mark> <mark>and</mark> there <mark>by</mark> "
      "<mark>the</mark> down",
      results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  results = coll1
                ->search(R"("by the" "there by")", {"title"}, "", {}, {}, {0},
                         10, 1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(2, results["hits"].size());
  ...
  results = coll1
                ->search(R"("by the" "there by")", {"title"}, "points:>=1", {},
                         {}, {0}, 10, 1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ...
  // single token phrase
  results = coll1
                ->search(R"("trooper")", {"title"}, "points:>=1", {}, {}, {0},
                         10, 1, FREQUENCY, {false}, 10)
                .get();
  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("2", results["hits"][0]["document"]["id"].get<std::string>());
...
TEST_F(CollectionSpecificTest, PhraseSearchMultiBlockToken) {
  ...
  // the word "train"'s posting list will spread > 1 block (since 300 docs
  // contain it)
  ...
  results = coll1
                ->search(R"("train is")", {"title"}, "", {}, {}, {2}, 10, 1,
                         FREQUENCY, {true})
                .get();
...
TEST_F(CollectionSpecificTest, PhraseSearchMultipleFields) {
  ...
  auto results =
      coll1
          ->search(R"("dog shoemaker")", {"title", "description"}, "", {}, {},
                   {2, 2}, 10, 1, FREQUENCY, {true, true}, 10)
          .get();
  ...
  results = coll1
                ->search(R"("dog and cat")", {"title", "description"}, "", {},
                         {}, {2, 2}, 10, 1, FREQUENCY, {true, true}, 10)
                .get();
  ...
  results = coll1
                ->search(R"("dog and cat")", {"title", "description"},
                         "description: about", {}, {}, {2, 2}, 10, 1, FREQUENCY,
                         {true, true}, 10)
                .get();
...
TEST_F(CollectionSpecificTest, PhraseSearchMultipleFieldsWithWeights) {
  ...
  auto results =
      coll1
          ->search(R"("there were none")", {"title", "description"}, "", {}, {},
                   {2, 2}, 10, 1, FREQUENCY, {true, true}, 10,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "", 40,
                   {}, {}, {}, 0, "<mark>", "</mark>", {10, 2})
...
TEST_F(CollectionSpecificTest, HandleLargeWeights) {
  ...
  auto results =
      coll1
          ->search("foo same", {"title", "description"}, "", {}, {}, {2, 2}, 10,
                   1, FREQUENCY, {true, true}, 10,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {1, 2}, 1000, true)
          .get();

  ASSERT_EQ(2, results["hits"].size());
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("0", results["hits"][1]["document"]["id"].get<std::string>());
  ASSERT_TRUE(results["hits"][0]["text_match"].get<size_t>() >
              results["hits"][1]["text_match"].get<size_t>());

  results = coll1
                ->search("foo same", {"title", "description"}, "", {}, {},
                         {2, 2}, 10, 1, FREQUENCY, {true, true}, 10,
                         spp::sparse_hash_set<std::string>(),
                         spp::sparse_hash_set<std::string>(), 10, "", 30, 4,
                         "title", 20, {}, {}, {}, 0, "<mark>", "</mark>",
                         {128, 130}, 1000, true)
                .get();
...
TEST_F(CollectionSpecificTest,
       VerbatimMatchShouldOverpowerHigherWeightedField) {
  std::vector<field> fields = {
      field("title", field_types::STRING, false),
      field("description", field_types::STRING, false),
      field("points", field_types::INT32, false),
  ...
  auto results =
      coll1
          ->search("shoes", {"title", "description"}, "", {}, {}, {2, 2}, 10, 1,
                   FREQUENCY, {true, true}, 10,
                   spp::sparse_hash_set<std::string>(),
                   spp::sparse_hash_set<std::string>(), 10, "", 30, 4, "title",
                   20, {}, {}, {}, 0, "<mark>", "</mark>", {4, 1}, 1000, true)
          .get();
...
TEST_F(CollectionSpecificTest, DropTokensTillOneToken) {
  ...
  auto results = coll1
                     ->search("harry malcolm roscow", {"title"}, "", {}, {},
  ...
  results = coll1
                ->search("harry malcolm roscow", {"title"}, "", {}, {}, {2}, 10,
                         1, FREQUENCY, {true}, 1)
                .get();
...
TEST_F(CollectionSpecificTest, NegationOfTokens) {
  ...
  auto results = coll1
                     ->search("galaxy -buds -maska -cover", {"title"}, "", {},
                              {}, {2}, 10, 1, FREQUENCY, {true}, 10)
                     .get();
  ...
  results = coll1
                ->search("-white -bronze -bijeli", {"title"}, "", {}, {}, {2},
...
TEST_F(CollectionSpecificTest, PhraseSearchOnLongText) {
  ...
  std::vector<std::vector<std::string>> records = {
      {"He goes, Sir, why don't you drive? (Laughter) I don't know where we're "
       "going. Neither do I. It will be an adventure, sir. (Laughter) The "
       "Middle East has been an adventure the past couple of years. It is "
       "going crazy with the Arab Spring and revolution and all this. Are "
       "there any Lebanese here tonight, by applause? (Cheering) Lebanese, "
       "yeah. The Middle East is going crazy. You know the Middle East is "
       "going crazy when Lebanon is the most peaceful place in the region. "
       "(Laughter) (Applause) Who would have thought? (Laughter) Oh my gosh."},
      {"Bear in mind this was an ultrasound, so it would have been moving "
       "images. It is a reflex of the autonomic nervous system. Now, this is "
       "the part of the nervous system that deals with the things that we "
       "don't consciously control."},
      {"So there will be a shared autonomy fleet where you buy your car and "
       "you can choose to use that car exclusively, you could choose to have "
       "it be used only by friends and family."}};
...
TEST_F(CollectionSpecificTest, RepeatedTokensInArray) {
  ...
  auto results = coll1
                     ->search("harry", {"tags"}, "", {}, {}, {2}, 10, 1,
                              FREQUENCY, {true}, 10)
                     .get();

  ASSERT_EQ(3, results["hits"].size());
  ASSERT_EQ(results["hits"][0]["text_match"].get<size_t>(),
            results["hits"][1]["text_match"].get<size_t>());
  ASSERT_EQ(results["hits"][1]["text_match"].get<size_t>(),
            results["hits"][2]["text_match"].get<size_t>());
...
TEST_F(CollectionSpecificTest, HighlightPrefixProperly) {
  ...
  auto results = coll1
                     ->search("cindrella o", {"title"}, "", {}, {}, {2}, 10, 1,
                              FREQUENCY, {true}, 1)
                     .get();

  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("0", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("<mark>Cinderella</mark>: the story.",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
...
TEST_F(CollectionSpecificTest, DontHighlightPunctuation) {
  ...
  auto results = coll1
                     ->search("readability", {"title"}, "", {}, {}, {2}, 10, 1,
                              FREQUENCY, {true}, 1)
                     .get();
  ...
  ASSERT_EQ("??Ensure! <mark>readability</mark>, use a legible font.",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
  ASSERT_EQ(
      "Too much clutter-- use <mark>readability</mark>.js to clean up the "
      "page.",
      results["hits"][1]["highlights"][0]["snippet"].get<std::string>());

  results = coll1
                ->search("clutter", {"title"}, "", {}, {}, {2}, 10, 1,
                         FREQUENCY, {true}, 1)
                .get();
  ...
  ASSERT_EQ("1", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ(
      "Too much <mark>clutter</mark>-- use readability.js to clean up the "
      "page.",
      results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  results = coll1
                ->search("ensure", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {true}, 1)
                .get();

  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("0", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("??<mark>Ensure</mark>! readability, use a legible font.",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());

  results = coll1
                ->search("dmonte", {"title"}, "", {}, {}, {2}, 10, 1, FREQUENCY,
                         {true}, 1)
                .get();

  ASSERT_EQ(1, results["hits"].size());
  ASSERT_EQ("2", results["hits"][0]["document"]["id"].get<std::string>());
  ASSERT_EQ("'<mark>DMonte</mark> Harris",
            results["hits"][0]["highlights"][0]["snippet"].get<std::string>());
